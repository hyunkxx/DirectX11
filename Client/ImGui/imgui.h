...
#define IM_OFFSETOF(m_eCollType,_MEMBER)  offsetof(m_eCollType, _MEMBER)                    // Offset of _MEMBER within m_eCollType. Standardized as offsetof() in C++11
...
namespace ImGui
{
    ...
    IMGUI_API bool          DragScalar(const char* label, ImGuiDataType datam_eCollType, void* p_data, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          DragScalarN(const char* label, ImGuiDataType datam_eCollType, void* p_data, int components, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType datam_eCollType, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalarN(const char* label, ImGuiDataType datam_eCollType, void* p_data, int components, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderFloat(const char* label, const ImVec2& size, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderInt(const char* label, const ImVec2& size, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderScalar(const char* label, const ImVec2& size, ImGuiDataType datam_eCollType, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          InputScalar(const char* label, ImGuiDataType datam_eCollType, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputScalarN(const char* label, ImGuiDataType datam_eCollType, void* p_data, int components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
    ...
    IMGUI_API void          SetMouseCursor(ImGuiMouseCursor cursorm_eCollType);                       // set desired mouse cursor shape
...
#define IMGUI_PAYLOADm_eCollType_COLOR_3F     "_COL3F"    // float[3]: Standard type for colors, without alpha. User code may use this type.
#define IMGUI_PAYLOADm_eCollType_COLOR_4F     "_COL4F"    // float[4]: Standard type for colors. User code may use this type.
...
#define IM_NEW(m_eCollType)                       new(ImNewWrapper(), ImGui::MemAlloc(sizeof(m_eCollType))) m_eCollType
...
struct ImVector
{
    ...
    typedef T                   valuem_eCollType;
    typedef valuem_eCollType*         iterator;
    typedef const valuem_eCollType*   const_iterator;
...
namespace ImGui
{
    ...
    //IMGUI_API bool      DragScalar(const char* label, ImGuiDataType datam_eCollType, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, float power = 1.0f)                                                            // OBSOLETED in 1.78 (from June 2020)
    //IMGUI_API bool      DragScalarN(const char* label, ImGuiDataType datam_eCollType, void* p_data, int components, float v_speed, const void* p_min, const void* p_max, const char* format, float power = 1.0f);                                          // OBSOLETED in 1.78 (from June 2020)
    //IMGUI_API bool      SliderScalar(const char* label, ImGuiDataType datam_eCollType, void* p_data, const void* p_min, const void* p_max, const char* format, float power = 1.0f);                                                                        // OBSOLETED in 1.78 (from June 2020)
    //IMGUI_API bool      SliderScalarN(const char* label, ImGuiDataType datam_eCollType, void* p_data, int components, const void* p_min, const void* p_max, const char* format, float power = 1.0f);                                                       // OBSOLETED in 1.78 (from June 2020)
