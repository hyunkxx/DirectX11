#include "stdafx.h"
#include "..\Public\Tree_9.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_9::CTree_9(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_9::CTree_9(const CTree_9 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_9::Initialize_Prototype()
{
...
HRESULT CTree_9::Initialize(void * pArg)
{
...
void CTree_9::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_9::LateTick(_double TimeDelta)
{
...
HRESULT CTree_9::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_9 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_9::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_9,
...
HRESULT CTree_9::SetUp_ShaderResources()
{
...
HRESULT CTree_9::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_9 * CTree_9::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_9* pInstance = new CTree_9(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_9");
...
CGameObject * CTree_9::Clone(void * pArg)
{
	CTree_9* pInstance = new CTree_9(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_9");
		Safe_Release(pInstance);
	}
