#include "stdafx.h"
#include "..\Public\Tree_17.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_17::CTree_17(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_17::CTree_17(const CTree_17 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_17::Initialize_Prototype()
{
...
HRESULT CTree_17::Initialize(void * pArg)
{
...
void CTree_17::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_17::LateTick(_double TimeDelta)
{
...
HRESULT CTree_17::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_17 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_17::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_17,
...
HRESULT CTree_17::SetUp_ShaderResources()
{
...
HRESULT CTree_17::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_17 * CTree_17::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_17* pInstance = new CTree_17(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_17");
...
CGameObject * CTree_17::Clone(void * pArg)
{
	CTree_17* pInstance = new CTree_17(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_17");
		Safe_Release(pInstance);
	}
