#include "stdafx.h"
#include "..\Public\Rock_18.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_18::CRock_18(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_18::CRock_18(const CRock_18 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_18::Initialize_Prototype()
{
...
HRESULT CRock_18::Initialize(void * pArg)
{
...
void CRock_18::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_18::LateTick(_double TimeDelta)
{
...
HRESULT CRock_18::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_18 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_18::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_18,
...
HRESULT CRock_18::SetUp_ShaderResources()
{
...
HRESULT CRock_18::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_18 * CRock_18::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_18* pInstance = new CRock_18(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_18");
...
CGameObject * CRock_18::Clone(void * pArg)
{
	CRock_18* pInstance = new CRock_18(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_18");
		Safe_Release(pInstance);
	}
