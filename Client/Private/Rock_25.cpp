#include "stdafx.h"
#include "..\Public\Rock_25.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_25::CRock_25(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_25::CRock_25(const CRock_25 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_25::Initialize_Prototype()
{
...
HRESULT CRock_25::Initialize(void * pArg)
{
...
void CRock_25::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_25::LateTick(_double TimeDelta)
{
...
HRESULT CRock_25::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_25 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_25::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_25,
...
HRESULT CRock_25::SetUp_ShaderResources()
{
...
HRESULT CRock_25::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_25 * CRock_25::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_25* pInstance = new CRock_25(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_25");
...
CGameObject * CRock_25::Clone(void * pArg)
{
	CRock_25* pInstance = new CRock_25(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_25");
		Safe_Release(pInstance);
	}
