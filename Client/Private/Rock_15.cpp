#include "stdafx.h"
#include "..\Public\Rock_15.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_15::CRock_15(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_15::CRock_15(const CRock_15 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_15::Initialize_Prototype()
{
...
HRESULT CRock_15::Initialize(void * pArg)
{
...
void CRock_15::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_15::LateTick(_double TimeDelta)
{
...
HRESULT CRock_15::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_15 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_15::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_15,
...
HRESULT CRock_15::SetUp_ShaderResources()
{
...
HRESULT CRock_15::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_15 * CRock_15::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_15* pInstance = new CRock_15(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_15");
...
CGameObject * CRock_15::Clone(void * pArg)
{
	CRock_15* pInstance = new CRock_15(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_15");
		Safe_Release(pInstance);
	}
