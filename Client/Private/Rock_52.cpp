#include "stdafx.h"
#include "..\Public\Rock_52.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_52::CRock_52(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_52::CRock_52(const CRock_52 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_52::Initialize_Prototype()
{
...
HRESULT CRock_52::Initialize(void * pArg)
{
...
void CRock_52::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_52::LateTick(_double TimeDelta)
{
...
HRESULT CRock_52::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_52 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_52::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_52,
...
HRESULT CRock_52::SetUp_ShaderResources()
{
...
HRESULT CRock_52::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_52 * CRock_52::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_52* pInstance = new CRock_52(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_52");
...
CGameObject * CRock_52::Clone(void * pArg)
{
	CRock_52* pInstance = new CRock_52(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_52");
		Safe_Release(pInstance);
	}
