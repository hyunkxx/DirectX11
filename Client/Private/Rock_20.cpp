#include "stdafx.h"
#include "..\Public\Rock_20.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_20::CRock_20(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_20::CRock_20(const CRock_20 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_20::Initialize_Prototype()
{
...
HRESULT CRock_20::Initialize(void * pArg)
{
...
void CRock_20::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_20::LateTick(_double TimeDelta)
{
...
HRESULT CRock_20::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_20 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_20::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_20,
...
HRESULT CRock_20::SetUp_ShaderResources()
{
...
HRESULT CRock_20::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_20 * CRock_20::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_20* pInstance = new CRock_20(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_20");
...
CGameObject * CRock_20::Clone(void * pArg)
{
	CRock_20* pInstance = new CRock_20(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_20");
		Safe_Release(pInstance);
	}
