#include "stdafx.h"
#include "..\Public\Tree_3.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_3::CTree_3(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_3::CTree_3(const CTree_3 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_3::Initialize_Prototype()
{
...
HRESULT CTree_3::Initialize(void * pArg)
{
...
void CTree_3::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_3::LateTick(_double TimeDelta)
{
...
HRESULT CTree_3::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_3 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_3::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_3,
...
HRESULT CTree_3::SetUp_ShaderResources()
{
...
HRESULT CTree_3::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_3 * CTree_3::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_3* pInstance = new CTree_3(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_3");
...
CGameObject * CTree_3::Clone(void * pArg)
{
	CTree_3* pInstance = new CTree_3(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_3");
		Safe_Release(pInstance);
	}
