#include "stdafx.h"
#include "..\Public\Rock_48.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_48::CRock_48(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_48::CRock_48(const CRock_48 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_48::Initialize_Prototype()
{
...
HRESULT CRock_48::Initialize(void * pArg)
{
...
void CRock_48::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_48::LateTick(_double TimeDelta)
{
...
HRESULT CRock_48::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_48 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_48::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_48,
...
HRESULT CRock_48::SetUp_ShaderResources()
{
...
HRESULT CRock_48::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_48 * CRock_48::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_48* pInstance = new CRock_48(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_48");
...
CGameObject * CRock_48::Clone(void * pArg)
{
	CRock_48* pInstance = new CRock_48(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_48");
		Safe_Release(pInstance);
	}
