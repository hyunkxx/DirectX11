#include "stdafx.h"
#include "..\Public\Tree_29.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_29::CTree_29(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_29::CTree_29(const CTree_29 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_29::Initialize_Prototype()
{
...
HRESULT CTree_29::Initialize(void * pArg)
{
...
void CTree_29::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_29::LateTick(_double TimeDelta)
{
...
HRESULT CTree_29::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_29 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_29::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_29,
...
HRESULT CTree_29::SetUp_ShaderResources()
{
...
HRESULT CTree_29::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_29 * CTree_29::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_29* pInstance = new CTree_29(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_29");
...
CGameObject * CTree_29::Clone(void * pArg)
{
	CTree_29* pInstance = new CTree_29(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_29");
		Safe_Release(pInstance);
	}
