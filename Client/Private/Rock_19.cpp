#include "stdafx.h"
#include "..\Public\Rock_19.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_19::CRock_19(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_19::CRock_19(const CRock_19 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_19::Initialize_Prototype()
{
...
HRESULT CRock_19::Initialize(void * pArg)
{
...
void CRock_19::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_19::LateTick(_double TimeDelta)
{
...
HRESULT CRock_19::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_19 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_19::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_19,
...
HRESULT CRock_19::SetUp_ShaderResources()
{
...
HRESULT CRock_19::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_19 * CRock_19::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_19* pInstance = new CRock_19(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_19");
...
CGameObject * CRock_19::Clone(void * pArg)
{
	CRock_19* pInstance = new CRock_19(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_19");
		Safe_Release(pInstance);
	}
