#include "stdafx.h"
#include "..\Public\Tree_6.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_6::CTree_6(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_6::CTree_6(const CTree_6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_6::Initialize_Prototype()
{
...
HRESULT CTree_6::Initialize(void * pArg)
{
...
void CTree_6::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_6::LateTick(_double TimeDelta)
{
...
HRESULT CTree_6::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_6 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_6::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_6,
...
HRESULT CTree_6::SetUp_ShaderResources()
{
...
HRESULT CTree_6::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_6 * CTree_6::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_6* pInstance = new CTree_6(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_6");
...
CGameObject * CTree_6::Clone(void * pArg)
{
	CTree_6* pInstance = new CTree_6(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_6");
		Safe_Release(pInstance);
	}
