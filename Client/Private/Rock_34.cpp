#include "stdafx.h"
#include "..\Public\Rock_34.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_34::CRock_34(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_34::CRock_34(const CRock_34 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_34::Initialize_Prototype()
{
...
HRESULT CRock_34::Initialize(void * pArg)
{
...
void CRock_34::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_34::LateTick(_double TimeDelta)
{
...
HRESULT CRock_34::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_34 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_34::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_34,
...
HRESULT CRock_34::SetUp_ShaderResources()
{
...
HRESULT CRock_34::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_34 * CRock_34::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_34* pInstance = new CRock_34(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_34");
...
CGameObject * CRock_34::Clone(void * pArg)
{
	CRock_34* pInstance = new CRock_34(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_34");
		Safe_Release(pInstance);
	}
