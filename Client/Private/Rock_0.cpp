#include "stdafx.h"
#include "..\Public\Rock_0.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_0::CRock_0(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_0::CRock_0(const CRock_0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_0::Initialize_Prototype()
{
...
HRESULT CRock_0::Initialize(void * pArg)
{
...
void CRock_0::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_0::LateTick(_double TimeDelta)
{
...
HRESULT CRock_0::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in Rock_0 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_0::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_0,
...
HRESULT CRock_0::SetUp_ShaderResources()
{
...
HRESULT CRock_0::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_0 * CRock_0::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_0* pInstance = new CRock_0(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_0");
...
CGameObject * CRock_0::Clone(void * pArg)
{
	CRock_0* pInstance = new CRock_0(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_0");
		Safe_Release(pInstance);
	}
