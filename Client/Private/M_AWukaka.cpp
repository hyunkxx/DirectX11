...
void CM_AWukaka::Change_Target(CCharacter * pActiveCharacter)
{
...
void CM_AWukaka::On_Hit(CCharacter * pChar, TAGATTACK * pAttackInfo, _float fAttackPoint, _float3 * pEffPos, _float fCritRate, _float fCritDMG)
{
	// 피격 이펙트 출력
