#include "stdafx.h"
#include "..\Public\Tree_27.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_27::CTree_27(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_27::CTree_27(const CTree_27 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_27::Initialize_Prototype()
{
...
HRESULT CTree_27::Initialize(void * pArg)
{
...
void CTree_27::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_27::LateTick(_double TimeDelta)
{
...
HRESULT CTree_27::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_27 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_27::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_27,
...
HRESULT CTree_27::SetUp_ShaderResources()
{
...
HRESULT CTree_27::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_27 * CTree_27::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_27* pInstance = new CTree_27(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_27");
...
CGameObject * CTree_27::Clone(void * pArg)
{
	CTree_27* pInstance = new CTree_27(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_27");
		Safe_Release(pInstance);
	}
