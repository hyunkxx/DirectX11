#include "stdafx.h"
#include "..\Public\Rock_13.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_13::CRock_13(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_13::CRock_13(const CRock_13 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_13::Initialize_Prototype()
{
...
HRESULT CRock_13::Initialize(void * pArg)
{
...
void CRock_13::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_13::LateTick(_double TimeDelta)
{
...
HRESULT CRock_13::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_13 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_13::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_13,
...
HRESULT CRock_13::SetUp_ShaderResources()
{
...
HRESULT CRock_13::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_13 * CRock_13::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_13* pInstance = new CRock_13(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_13");
...
CGameObject * CRock_13::Clone(void * pArg)
{
	CRock_13* pInstance = new CRock_13(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_13");
		Safe_Release(pInstance);
	}
