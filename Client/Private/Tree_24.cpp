#include "stdafx.h"
#include "..\Public\Tree_24.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_24::CTree_24(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_24::CTree_24(const CTree_24 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_24::Initialize_Prototype()
{
...
HRESULT CTree_24::Initialize(void * pArg)
{
...
void CTree_24::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_24::LateTick(_double TimeDelta)
{
...
HRESULT CTree_24::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_24 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_24::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_24,
...
HRESULT CTree_24::SetUp_ShaderResources()
{
...
HRESULT CTree_24::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_24 * CTree_24::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_24* pInstance = new CTree_24(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_24");
...
CGameObject * CTree_24::Clone(void * pArg)
{
	CTree_24* pInstance = new CTree_24(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_24");
		Safe_Release(pInstance);
	}
