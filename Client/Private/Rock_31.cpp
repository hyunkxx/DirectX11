#include "stdafx.h"
#include "..\Public\Rock_31.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_31::CRock_31(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_31::CRock_31(const CRock_31 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_31::Initialize_Prototype()
{
...
HRESULT CRock_31::Initialize(void * pArg)
{
...
void CRock_31::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_31::LateTick(_double TimeDelta)
{
...
HRESULT CRock_31::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_31 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_31::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_31,
...
HRESULT CRock_31::SetUp_ShaderResources()
{
...
HRESULT CRock_31::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_31 * CRock_31::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_31* pInstance = new CRock_31(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_31");
...
CGameObject * CRock_31::Clone(void * pArg)
{
	CRock_31* pInstance = new CRock_31(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_31");
		Safe_Release(pInstance);
	}
