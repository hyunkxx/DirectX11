#include "stdafx.h"
#include "..\Public\Rock_49.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_49::CRock_49(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_49::CRock_49(const CRock_49 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_49::Initialize_Prototype()
{
...
HRESULT CRock_49::Initialize(void * pArg)
{
...
void CRock_49::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_49::LateTick(_double TimeDelta)
{
...
HRESULT CRock_49::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_49 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_49::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_49,
...
HRESULT CRock_49::SetUp_ShaderResources()
{
...
HRESULT CRock_49::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_49 * CRock_49::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_49* pInstance = new CRock_49(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_49");
...
CGameObject * CRock_49::Clone(void * pArg)
{
	CRock_49* pInstance = new CRock_49(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_49");
		Safe_Release(pInstance);
	}
