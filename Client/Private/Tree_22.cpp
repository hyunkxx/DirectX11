#include "stdafx.h"
#include "..\Public\Tree_22.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_22::CTree_22(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_22::CTree_22(const CTree_22 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_22::Initialize_Prototype()
{
...
HRESULT CTree_22::Initialize(void * pArg)
{
...
void CTree_22::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_22::LateTick(_double TimeDelta)
{
...
HRESULT CTree_22::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_22 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_22::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_22,
...
HRESULT CTree_22::SetUp_ShaderResources()
{
...
HRESULT CTree_22::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_22 * CTree_22::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_22* pInstance = new CTree_22(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_22");
...
CGameObject * CTree_22::Clone(void * pArg)
{
	CTree_22* pInstance = new CTree_22(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_22");
		Safe_Release(pInstance);
	}
