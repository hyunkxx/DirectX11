#include "stdafx.h"
#include "..\Public\Rock_6.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_6::CRock_6(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_6::CRock_6(const CRock_6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_6::Initialize_Prototype()
{
...
HRESULT CRock_6::Initialize(void * pArg)
{
...
void CRock_6::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_6::LateTick(_double TimeDelta)
{
...
HRESULT CRock_6::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_6 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_6::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_6,
...
HRESULT CRock_6::SetUp_ShaderResources()
{
...
HRESULT CRock_6::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_6 * CRock_6::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_6* pInstance = new CRock_6(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_6");
...
CGameObject * CRock_6::Clone(void * pArg)
{
	CRock_6* pInstance = new CRock_6(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_6");
		Safe_Release(pInstance);
	}
