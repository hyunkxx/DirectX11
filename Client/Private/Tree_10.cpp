#include "stdafx.h"
#include "..\Public\Tree_10.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_10::CTree_10(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_10::CTree_10(const CTree_10 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_10::Initialize_Prototype()
{
...
HRESULT CTree_10::Initialize(void * pArg)
{
...
void CTree_10::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_10::LateTick(_double TimeDelta)
{
...
HRESULT CTree_10::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_10 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_10::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_10,
...
HRESULT CTree_10::SetUp_ShaderResources()
{
...
HRESULT CTree_10::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_10 * CTree_10::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_10* pInstance = new CTree_10(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_10");
...
CGameObject * CTree_10::Clone(void * pArg)
{
	CTree_10* pInstance = new CTree_10(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_10");
		Safe_Release(pInstance);
	}
