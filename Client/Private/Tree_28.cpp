#include "stdafx.h"
#include "..\Public\Tree_28.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_28::CTree_28(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_28::CTree_28(const CTree_28 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_28::Initialize_Prototype()
{
...
HRESULT CTree_28::Initialize(void * pArg)
{
...
void CTree_28::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_28::LateTick(_double TimeDelta)
{
...
HRESULT CTree_28::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_28 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_28::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_28,
...
HRESULT CTree_28::SetUp_ShaderResources()
{
...
HRESULT CTree_28::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_28 * CTree_28::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_28* pInstance = new CTree_28(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_28");
...
CGameObject * CTree_28::Clone(void * pArg)
{
	CTree_28* pInstance = new CTree_28(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_28");
		Safe_Release(pInstance);
	}
