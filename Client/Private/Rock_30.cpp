#include "stdafx.h"
#include "..\Public\Rock_30.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_30::CRock_30(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_30::CRock_30(const CRock_30 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_30::Initialize_Prototype()
{
...
HRESULT CRock_30::Initialize(void * pArg)
{
...
void CRock_30::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_30::LateTick(_double TimeDelta)
{
...
HRESULT CRock_30::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_30 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_30::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_30,
...
HRESULT CRock_30::SetUp_ShaderResources()
{
...
HRESULT CRock_30::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_30 * CRock_30::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_30* pInstance = new CRock_30(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_30");
...
CGameObject * CRock_30::Clone(void * pArg)
{
	CRock_30* pInstance = new CRock_30(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_30");
		Safe_Release(pInstance);
	}
