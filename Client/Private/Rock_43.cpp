#include "stdafx.h"
#include "..\Public\Rock_43.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_43::CRock_43(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_43::CRock_43(const CRock_43 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_43::Initialize_Prototype()
{
...
HRESULT CRock_43::Initialize(void * pArg)
{
...
void CRock_43::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_43::LateTick(_double TimeDelta)
{
...
HRESULT CRock_43::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_43 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_43::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_43,
...
HRESULT CRock_43::SetUp_ShaderResources()
{
...
HRESULT CRock_43::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_43 * CRock_43::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_43* pInstance = new CRock_43(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_43");
...
CGameObject * CRock_43::Clone(void * pArg)
{
	CRock_43* pInstance = new CRock_43(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_43");
		Safe_Release(pInstance);
	}
