#include "stdafx.h"
#include "..\Public\Rock_42.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_42::CRock_42(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_42::CRock_42(const CRock_42 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_42::Initialize_Prototype()
{
...
HRESULT CRock_42::Initialize(void * pArg)
{
...
void CRock_42::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_42::LateTick(_double TimeDelta)
{
...
HRESULT CRock_42::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_42 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_42::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_42,
...
HRESULT CRock_42::SetUp_ShaderResources()
{
...
HRESULT CRock_42::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_42 * CRock_42::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_42* pInstance = new CRock_42(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_42");
...
CGameObject * CRock_42::Clone(void * pArg)
{
	CRock_42* pInstance = new CRock_42(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_42");
		Safe_Release(pInstance);
	}
