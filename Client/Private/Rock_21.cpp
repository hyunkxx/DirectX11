#include "stdafx.h"
#include "..\Public\Rock_21.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_21::CRock_21(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_21::CRock_21(const CRock_21 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_21::Initialize_Prototype()
{
...
HRESULT CRock_21::Initialize(void * pArg)
{
...
void CRock_21::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_21::LateTick(_double TimeDelta)
{
...
HRESULT CRock_21::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_21 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_21::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_21,
...
HRESULT CRock_21::SetUp_ShaderResources()
{
...
HRESULT CRock_21::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_21 * CRock_21::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_21* pInstance = new CRock_21(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_21");
...
CGameObject * CRock_21::Clone(void * pArg)
{
	CRock_21* pInstance = new CRock_21(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_21");
		Safe_Release(pInstance);
	}
