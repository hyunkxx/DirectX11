#include "stdafx.h"
#include "..\Public\Tree_7.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_7::CTree_7(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_7::CTree_7(const CTree_7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_7::Initialize_Prototype()
{
...
HRESULT CTree_7::Initialize(void * pArg)
{
...
void CTree_7::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_7::LateTick(_double TimeDelta)
{
...
HRESULT CTree_7::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_7 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_7::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_7,
...
HRESULT CTree_7::SetUp_ShaderResources()
{
...
HRESULT CTree_7::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_7 * CTree_7::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_7* pInstance = new CTree_7(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_7");
...
CGameObject * CTree_7::Clone(void * pArg)
{
	CTree_7* pInstance = new CTree_7(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_7");
		Safe_Release(pInstance);
	}
