#include "stdafx.h"
#include "..\Public\Rock_12.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_12::CRock_12(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_12::CRock_12(const CRock_12 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_12::Initialize_Prototype()
{
...
HRESULT CRock_12::Initialize(void * pArg)
{
...
void CRock_12::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_12::LateTick(_double TimeDelta)
{
...
HRESULT CRock_12::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_12 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_12::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_12,
...
HRESULT CRock_12::SetUp_ShaderResources()
{
...
HRESULT CRock_12::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_12 * CRock_12::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_12* pInstance = new CRock_12(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_12");
...
CGameObject * CRock_12::Clone(void * pArg)
{
	CRock_12* pInstance = new CRock_12(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_12");
		Safe_Release(pInstance);
	}
