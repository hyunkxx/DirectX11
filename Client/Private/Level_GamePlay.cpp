...
HRESULT CLevel_GamePlay::Ready_Layer_MapObject_NoiRock(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	if (nullptr == pGameInstance)
		return E_FAIL;
	...
	EditionDesc.fCullingRatio = 30.0f;
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_0");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_1");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_2");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_3");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_4");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_5");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_6");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Noi_Rock"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_NOIROCK_7");
		return E_FAIL;
	}
...
HRESULT CLevel_GamePlay::Ready_Layer_MapObject_Tof_Grass(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	if (nullptr == pGameInstance)
		return E_FAIL;
	...
	EditionDesc.fCullingRatio = 30.0f;
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_0");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_1");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_2");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_3");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_4");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_5");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_6");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_7");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_8");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_9");
		return E_FAIL;
	}
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_10");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_11");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_12");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_13");
		return E_FAIL;
	}
	ZeroMemory(&EditionDesc, sizeof(SMAP_OBJECT_EDITION_DESC));
	...
	if (FAILED(pGameInstance->Add_GameObject(LEVEL_GAMEPLAY, OBJECT::MAP_OBJECT, pLayerTag, TEXT("MapObject_Tof_Grass"), &EditionDesc)))
	{
		MSG_BOX("Failed to AddGameObejct In Level_GamePlay : SIMD_TOF_GRASS_14");
		return E_FAIL;
	}
