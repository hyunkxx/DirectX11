...
void CUI_Tip::RenderGUI()
{
	...
	if (0 < (_int)m_DescList.size())
	{
		if(ImGui::InputInt("Index", &m_Index)){ m_DescList[m_Index]; }
		ImGui::Separator();
		ImGui::InputInt("pass", &m_DescList[m_Index].iPass);
		ImGui::InputInt("texNum", &(m_DescList[m_Index].iTexNum));
		ImGui::NewLine();
		ImGui::InputInt("MainMaskNum", &m_MainMaskNum);

		_float4 Pos = _float4{ m_DescList[m_Index].fX, m_DescList[m_Index].fY, m_DescList[m_Index].fZ, 1.f };
		ImGui::InputFloat3("TipPos", &Pos.x, "%.2f");
		ImGui::SliderFloat("TipX", &Pos.x, -640.f, 640.f);
		ImGui::SliderFloat("TipY", &Pos.y, -360.f, 360.f);
		ImGui::SliderFloat("TipZ", &Pos.z, -1.f, 1.f);
		m_DescList[m_Index].fX = m_DescList[m_Index].WorldMatrix._41 = Pos.x;
		m_DescList[m_Index].fY = m_DescList[m_Index].WorldMatrix._42 = Pos.y;
		m_DescList[m_Index].fZ = m_DescList[m_Index].WorldMatrix._43 = Pos.z;
		ImGui::Separator();


		ImGui::InputFloat("TipScaleX", &(m_DescList[m_Index].fWidth));
		ImGui::NewLine();
		ImGui::InputFloat("TipScaleY", &(m_DescList[m_Index].fHeight));
		ImGui::NewLine();
		ImGui::SliderFloat("sTipScaleX", &(m_DescList[m_Index].fWidth), 0.1f, 1280.f);
		ImGui::NewLine();
		ImGui::SliderFloat("sTipScaleY", &(m_DescList[m_Index].fHeight), 0.1f, 720.f);
		ImGui::NewLine();
		m_DescList[m_Index].WorldMatrix._11 = m_DescList[m_Index].fWidth;
		m_DescList[m_Index].WorldMatrix._22 = m_DescList[m_Index].fHeight;
		ImGui::Separator();

		// ¾ËÆÄ°ª
		m_DescList[m_Index].Color.x = m_DescList[m_Index].fColorR;
		m_DescList[m_Index].Color.y = m_DescList[m_Index].fColorG;
		m_DescList[m_Index].Color.z = m_DescList[m_Index].fColorB;
		m_DescList[m_Index].Color.w = m_DescList[m_Index].fColorA;
		if (ImGui::InputFloat("R", &(m_DescList[m_Index].Color.x))) { m_DescList[m_Index].fColorR = m_DescList[m_Index].Color.x; }
		if (ImGui::InputFloat("G", &(m_DescList[m_Index].Color.y))) { m_DescList[m_Index].fColorG = m_DescList[m_Index].Color.y; }
		if (ImGui::InputFloat("B", &(m_DescList[m_Index].Color.z))) { m_DescList[m_Index].fColorB = m_DescList[m_Index].Color.z; }
		if (ImGui::InputFloat("A", &(m_DescList[m_Index].Color.w))) { m_DescList[m_Index].fColorA = m_DescList[m_Index].Color.w; }
		if (ImGui::SliderFloat("sR", &(m_DescList[m_Index].Color.x), -255.f, 255.f)) { m_DescList[m_Index].fColorR = m_DescList[m_Index].Color.x; }
		if (ImGui::SliderFloat("sG", &(m_DescList[m_Index].Color.y), -255.f, 255.f)) { m_DescList[m_Index].fColorG = m_DescList[m_Index].Color.y; }
		if (ImGui::SliderFloat("sB", &(m_DescList[m_Index].Color.z), -255.f, 255.f)) { m_DescList[m_Index].fColorB = m_DescList[m_Index].Color.z; }
		if (ImGui::SliderFloat("sA", &(m_DescList[m_Index].Color.w), -255.f, 255.f)) { m_DescList[m_Index].fColorA = m_DescList[m_Index].Color.w; }
	}
