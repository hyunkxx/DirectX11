#include "stdafx.h"
#include "..\Public\Rock_8.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_8::CRock_8(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_8::CRock_8(const CRock_8 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_8::Initialize_Prototype()
{
...
HRESULT CRock_8::Initialize(void * pArg)
{
...
void CRock_8::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_8::LateTick(_double TimeDelta)
{
...
HRESULT CRock_8::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_8 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_8::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_8,
...
HRESULT CRock_8::SetUp_ShaderResources()
{
...
HRESULT CRock_8::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_8 * CRock_8::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_8* pInstance = new CRock_8(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_8");
...
CGameObject * CRock_8::Clone(void * pArg)
{
	CRock_8* pInstance = new CRock_8(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_8");
		Safe_Release(pInstance);
	}
