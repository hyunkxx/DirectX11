#include "stdafx.h"
#include "..\Public\Rock_46.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_46::CRock_46(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_46::CRock_46(const CRock_46 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_46::Initialize_Prototype()
{
...
HRESULT CRock_46::Initialize(void * pArg)
{
...
void CRock_46::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_46::LateTick(_double TimeDelta)
{
...
HRESULT CRock_46::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_46 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_46::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_46,
...
HRESULT CRock_46::SetUp_ShaderResources()
{
...
HRESULT CRock_46::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_46 * CRock_46::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_46* pInstance = new CRock_46(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_46");
...
CGameObject * CRock_46::Clone(void * pArg)
{
	CRock_46* pInstance = new CRock_46(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_46");
		Safe_Release(pInstance);
	}
