#include "stdafx.h"
#include "..\Public\Rock_44.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_44::CRock_44(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_44::CRock_44(const CRock_44 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_44::Initialize_Prototype()
{
...
HRESULT CRock_44::Initialize(void * pArg)
{
...
void CRock_44::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_44::LateTick(_double TimeDelta)
{
...
HRESULT CRock_44::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_44 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_44::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_44,
...
HRESULT CRock_44::SetUp_ShaderResources()
{
...
HRESULT CRock_44::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_44 * CRock_44::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_44* pInstance = new CRock_44(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_44");
...
CGameObject * CRock_44::Clone(void * pArg)
{
	CRock_44* pInstance = new CRock_44(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_44");
		Safe_Release(pInstance);
	}
