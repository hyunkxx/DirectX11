#include "stdafx.h"
#include "..\Public\Rock_17.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_17::CRock_17(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_17::CRock_17(const CRock_17 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_17::Initialize_Prototype()
{
...
HRESULT CRock_17::Initialize(void * pArg)
{
...
void CRock_17::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_17::LateTick(_double TimeDelta)
{
...
HRESULT CRock_17::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_17 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_17::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_17,
...
HRESULT CRock_17::SetUp_ShaderResources()
{
...
HRESULT CRock_17::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_17 * CRock_17::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_17* pInstance = new CRock_17(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_17");
...
CGameObject * CRock_17::Clone(void * pArg)
{
	CRock_17* pInstance = new CRock_17(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_17");
		Safe_Release(pInstance);
	}
