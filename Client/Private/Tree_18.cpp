#include "stdafx.h"
#include "..\Public\Tree_18.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_18::CTree_18(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_18::CTree_18(const CTree_18 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_18::Initialize_Prototype()
{
...
HRESULT CTree_18::Initialize(void * pArg)
{
...
void CTree_18::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_18::LateTick(_double TimeDelta)
{
...
HRESULT CTree_18::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_18 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_18::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_18,
...
HRESULT CTree_18::SetUp_ShaderResources()
{
...
HRESULT CTree_18::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_18 * CTree_18::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_18* pInstance = new CTree_18(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_18");
...
CGameObject * CTree_18::Clone(void * pArg)
{
	CTree_18* pInstance = new CTree_18(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_18");
		Safe_Release(pInstance);
	}
