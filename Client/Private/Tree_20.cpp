#include "stdafx.h"
#include "..\Public\Tree_20.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_20::CTree_20(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_20::CTree_20(const CTree_20 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_20::Initialize_Prototype()
{
...
HRESULT CTree_20::Initialize(void * pArg)
{
...
void CTree_20::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_20::LateTick(_double TimeDelta)
{
...
HRESULT CTree_20::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_20 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_20::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_20,
...
HRESULT CTree_20::SetUp_ShaderResources()
{
...
HRESULT CTree_20::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_20 * CTree_20::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_20* pInstance = new CTree_20(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_20");
...
CGameObject * CTree_20::Clone(void * pArg)
{
	CTree_20* pInstance = new CTree_20(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_20");
		Safe_Release(pInstance);
	}
