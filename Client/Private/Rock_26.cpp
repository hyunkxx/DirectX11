#include "stdafx.h"
#include "..\Public\Rock_26.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_26::CRock_26(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_26::CRock_26(const CRock_26 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_26::Initialize_Prototype()
{
...
HRESULT CRock_26::Initialize(void * pArg)
{
...
void CRock_26::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_26::LateTick(_double TimeDelta)
{
...
HRESULT CRock_26::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_26 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_26::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_26,
...
HRESULT CRock_26::SetUp_ShaderResources()
{
...
HRESULT CRock_26::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_26 * CRock_26::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_26* pInstance = new CRock_26(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_26");
...
CGameObject * CRock_26::Clone(void * pArg)
{
	CRock_26* pInstance = new CRock_26(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_26");
		Safe_Release(pInstance);
	}
