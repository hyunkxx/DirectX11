#include "stdafx.h"
#include "..\Public\Tree_30.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_30::CTree_30(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_30::CTree_30(const CTree_30 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_30::Initialize_Prototype()
{
...
HRESULT CTree_30::Initialize(void * pArg)
{
...
void CTree_30::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_30::LateTick(_double TimeDelta)
{
...
HRESULT CTree_30::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_30 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_30::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_30,
...
HRESULT CTree_30::SetUp_ShaderResources()
{
...
HRESULT CTree_30::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_30 * CTree_30::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_30* pInstance = new CTree_30(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_30");
...
CGameObject * CTree_30::Clone(void * pArg)
{
	CTree_30* pInstance = new CTree_30(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_30");
		Safe_Release(pInstance);
	}
