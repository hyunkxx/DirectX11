#include "stdafx.h"
#include "..\Public\Rock_14.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_14::CRock_14(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_14::CRock_14(const CRock_14 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_14::Initialize_Prototype()
{
...
HRESULT CRock_14::Initialize(void * pArg)
{
...
void CRock_14::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_14::LateTick(_double TimeDelta)
{
...
HRESULT CRock_14::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_14 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_14::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_14,
...
HRESULT CRock_14::SetUp_ShaderResources()
{
...
HRESULT CRock_14::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_14 * CRock_14::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_14* pInstance = new CRock_14(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_14");
...
CGameObject * CRock_14::Clone(void * pArg)
{
	CRock_14* pInstance = new CRock_14(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_14");
		Safe_Release(pInstance);
	}
