#include "stdafx.h"
#include "..\Public\Rock_11.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_11::CRock_11(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_11::CRock_11(const CRock_11 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_11::Initialize_Prototype()
{
...
HRESULT CRock_11::Initialize(void * pArg)
{
...
void CRock_11::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_11::LateTick(_double TimeDelta)
{
...
HRESULT CRock_11::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_11 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_11::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_11,
...
HRESULT CRock_11::SetUp_ShaderResources()
{
...
HRESULT CRock_11::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_11 * CRock_11::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_11* pInstance = new CRock_11(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_11");
...
CGameObject * CRock_11::Clone(void * pArg)
{
	CRock_11* pInstance = new CRock_11(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_11");
		Safe_Release(pInstance);
	}
