#include "stdafx.h"
#include "..\Public\Tree_5.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_5::CTree_5(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_5::CTree_5(const CTree_5 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_5::Initialize_Prototype()
{
...
HRESULT CTree_5::Initialize(void * pArg)
{
...
void CTree_5::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_5::LateTick(_double TimeDelta)
{
...
HRESULT CTree_5::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_5 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_5::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_5,
...
HRESULT CTree_5::SetUp_ShaderResources()
{
...
HRESULT CTree_5::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_5 * CTree_5::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_5* pInstance = new CTree_5(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_5");
...
CGameObject * CTree_5::Clone(void * pArg)
{
	CTree_5* pInstance = new CTree_5(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_5");
		Safe_Release(pInstance);
	}
