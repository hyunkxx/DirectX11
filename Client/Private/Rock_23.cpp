#include "stdafx.h"
#include "..\Public\Rock_23.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_23::CRock_23(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_23::CRock_23(const CRock_23 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_23::Initialize_Prototype()
{
...
HRESULT CRock_23::Initialize(void * pArg)
{
...
void CRock_23::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_23::LateTick(_double TimeDelta)
{
...
HRESULT CRock_23::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_23 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_23::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_23,
...
HRESULT CRock_23::SetUp_ShaderResources()
{
...
HRESULT CRock_23::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_23 * CRock_23::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_23* pInstance = new CRock_23(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_23");
...
CGameObject * CRock_23::Clone(void * pArg)
{
	CRock_23* pInstance = new CRock_23(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_23");
		Safe_Release(pInstance);
	}
