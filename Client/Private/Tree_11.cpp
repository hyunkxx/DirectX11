#include "stdafx.h"
#include "..\Public\Tree_11.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_11::CTree_11(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_11::CTree_11(const CTree_11 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_11::Initialize_Prototype()
{
...
HRESULT CTree_11::Initialize(void * pArg)
{
...
void CTree_11::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_11::LateTick(_double TimeDelta)
{
...
HRESULT CTree_11::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_11 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_11::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_11,
...
HRESULT CTree_11::SetUp_ShaderResources()
{
...
HRESULT CTree_11::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_11 * CTree_11::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_11* pInstance = new CTree_11(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_11");
...
CGameObject * CTree_11::Clone(void * pArg)
{
	CTree_11* pInstance = new CTree_11(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_11");
		Safe_Release(pInstance);
	}
