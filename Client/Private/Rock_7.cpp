#include "stdafx.h"
#include "..\Public\Rock_7.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_7::CRock_7(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_7::CRock_7(const CRock_7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_7::Initialize_Prototype()
{
...
HRESULT CRock_7::Initialize(void * pArg)
{
...
void CRock_7::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_7::LateTick(_double TimeDelta)
{
...
HRESULT CRock_7::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_7 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_7::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_7,
...
HRESULT CRock_7::SetUp_ShaderResources()
{
...
HRESULT CRock_7::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_7 * CRock_7::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_7* pInstance = new CRock_7(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_7");
...
CGameObject * CRock_7::Clone(void * pArg)
{
	CRock_7* pInstance = new CRock_7(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_7");
		Safe_Release(pInstance);
	}
