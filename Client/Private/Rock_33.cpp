#include "stdafx.h"
#include "..\Public\Rock_33.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_33::CRock_33(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_33::CRock_33(const CRock_33 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_33::Initialize_Prototype()
{
...
HRESULT CRock_33::Initialize(void * pArg)
{
...
void CRock_33::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_33::LateTick(_double TimeDelta)
{
...
HRESULT CRock_33::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_33 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_33::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_33,
...
HRESULT CRock_33::SetUp_ShaderResources()
{
...
HRESULT CRock_33::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_33 * CRock_33::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_33* pInstance = new CRock_33(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_33");
...
CGameObject * CRock_33::Clone(void * pArg)
{
	CRock_33* pInstance = new CRock_33(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_33");
		Safe_Release(pInstance);
	}
