#include "stdafx.h"
#include "..\Public\Tree_26.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_26::CTree_26(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_26::CTree_26(const CTree_26 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_26::Initialize_Prototype()
{
...
HRESULT CTree_26::Initialize(void * pArg)
{
...
void CTree_26::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_26::LateTick(_double TimeDelta)
{
...
HRESULT CTree_26::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_26 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_26::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_26,
...
HRESULT CTree_26::SetUp_ShaderResources()
{
...
HRESULT CTree_26::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_26 * CTree_26::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_26* pInstance = new CTree_26(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_26");
...
CGameObject * CTree_26::Clone(void * pArg)
{
	CTree_26* pInstance = new CTree_26(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_26");
		Safe_Release(pInstance);
	}
