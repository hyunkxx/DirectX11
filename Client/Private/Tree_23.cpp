#include "stdafx.h"
#include "..\Public\Tree_23.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_23::CTree_23(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_23::CTree_23(const CTree_23 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_23::Initialize_Prototype()
{
...
HRESULT CTree_23::Initialize(void * pArg)
{
...
void CTree_23::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_23::LateTick(_double TimeDelta)
{
...
HRESULT CTree_23::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_23 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_23::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_23,
...
HRESULT CTree_23::SetUp_ShaderResources()
{
...
HRESULT CTree_23::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_23 * CTree_23::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_23* pInstance = new CTree_23(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_23");
...
CGameObject * CTree_23::Clone(void * pArg)
{
	CTree_23* pInstance = new CTree_23(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_23");
		Safe_Release(pInstance);
	}
