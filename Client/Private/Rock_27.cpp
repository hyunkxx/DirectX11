#include "stdafx.h"
#include "..\Public\Rock_27.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_27::CRock_27(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_27::CRock_27(const CRock_27 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_27::Initialize_Prototype()
{
...
HRESULT CRock_27::Initialize(void * pArg)
{
...
void CRock_27::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_27::LateTick(_double TimeDelta)
{
...
HRESULT CRock_27::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_27 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_27::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_27,
...
HRESULT CRock_27::SetUp_ShaderResources()
{
...
HRESULT CRock_27::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_27 * CRock_27::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_27* pInstance = new CRock_27(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_27");
...
CGameObject * CRock_27::Clone(void * pArg)
{
	CRock_27* pInstance = new CRock_27(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_27");
		Safe_Release(pInstance);
	}
