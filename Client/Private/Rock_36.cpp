#include "stdafx.h"
#include "..\Public\Rock_36.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_36::CRock_36(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_36::CRock_36(const CRock_36 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_36::Initialize_Prototype()
{
...
HRESULT CRock_36::Initialize(void * pArg)
{
...
void CRock_36::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_36::LateTick(_double TimeDelta)
{
...
HRESULT CRock_36::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_36 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_36::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_36,
...
HRESULT CRock_36::SetUp_ShaderResources()
{
...
HRESULT CRock_36::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_36 * CRock_36::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_36* pInstance = new CRock_36(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_36");
...
CGameObject * CRock_36::Clone(void * pArg)
{
	CRock_36* pInstance = new CRock_36(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_36");
		Safe_Release(pInstance);
	}
