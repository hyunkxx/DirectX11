#include "stdafx.h"
#include "..\Public\Rock_24.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_24::CRock_24(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_24::CRock_24(const CRock_24 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_24::Initialize_Prototype()
{
...
HRESULT CRock_24::Initialize(void * pArg)
{
...
void CRock_24::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_24::LateTick(_double TimeDelta)
{
...
HRESULT CRock_24::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_24 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_24::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_24,
...
HRESULT CRock_24::SetUp_ShaderResources()
{
...
HRESULT CRock_24::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_24 * CRock_24::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_24* pInstance = new CRock_24(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_24");
...
CGameObject * CRock_24::Clone(void * pArg)
{
	CRock_24* pInstance = new CRock_24(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_24");
		Safe_Release(pInstance);
	}
