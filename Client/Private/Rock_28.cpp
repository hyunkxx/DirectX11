#include "stdafx.h"
#include "..\Public\Rock_28.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_28::CRock_28(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_28::CRock_28(const CRock_28 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_28::Initialize_Prototype()
{
...
HRESULT CRock_28::Initialize(void * pArg)
{
...
void CRock_28::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_28::LateTick(_double TimeDelta)
{
...
HRESULT CRock_28::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_28 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_28::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_28,
...
HRESULT CRock_28::SetUp_ShaderResources()
{
...
HRESULT CRock_28::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_28 * CRock_28::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_28* pInstance = new CRock_28(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_28");
...
CGameObject * CRock_28::Clone(void * pArg)
{
	CRock_28* pInstance = new CRock_28(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_28");
		Safe_Release(pInstance);
	}
