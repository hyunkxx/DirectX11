#include "stdafx.h"
#include "..\Public\Rock_29.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_29::CRock_29(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_29::CRock_29(const CRock_29 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_29::Initialize_Prototype()
{
...
HRESULT CRock_29::Initialize(void * pArg)
{
...
void CRock_29::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_29::LateTick(_double TimeDelta)
{
...
HRESULT CRock_29::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_29 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_29::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_29,
...
HRESULT CRock_29::SetUp_ShaderResources()
{
...
HRESULT CRock_29::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_29 * CRock_29::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_29* pInstance = new CRock_29(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_29");
...
CGameObject * CRock_29::Clone(void * pArg)
{
	CRock_29* pInstance = new CRock_29(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_29");
		Safe_Release(pInstance);
	}
