#include "stdafx.h"
#include "..\Public\Rock_41.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_41::CRock_41(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_41::CRock_41(const CRock_41 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_41::Initialize_Prototype()
{
...
HRESULT CRock_41::Initialize(void * pArg)
{
...
void CRock_41::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_41::LateTick(_double TimeDelta)
{
...
HRESULT CRock_41::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_41 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_41::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_41,
...
HRESULT CRock_41::SetUp_ShaderResources()
{
...
HRESULT CRock_41::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_41 * CRock_41::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_41* pInstance = new CRock_41(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_41");
...
CGameObject * CRock_41::Clone(void * pArg)
{
	CRock_41* pInstance = new CRock_41(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_41");
		Safe_Release(pInstance);
	}
