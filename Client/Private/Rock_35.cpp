#include "stdafx.h"
#include "..\Public\Rock_35.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_35::CRock_35(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_35::CRock_35(const CRock_35 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_35::Initialize_Prototype()
{
...
HRESULT CRock_35::Initialize(void * pArg)
{
...
void CRock_35::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_35::LateTick(_double TimeDelta)
{
...
HRESULT CRock_35::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_35 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_35::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_35,
...
HRESULT CRock_35::SetUp_ShaderResources()
{
...
HRESULT CRock_35::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_35 * CRock_35::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_35* pInstance = new CRock_35(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_35");
...
CGameObject * CRock_35::Clone(void * pArg)
{
	CRock_35* pInstance = new CRock_35(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_35");
		Safe_Release(pInstance);
	}
