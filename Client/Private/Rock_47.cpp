#include "stdafx.h"
#include "..\Public\Rock_47.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_47::CRock_47(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_47::CRock_47(const CRock_47 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_47::Initialize_Prototype()
{
...
HRESULT CRock_47::Initialize(void * pArg)
{
...
void CRock_47::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_47::LateTick(_double TimeDelta)
{
...
HRESULT CRock_47::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_47 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_47::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_47,
...
HRESULT CRock_47::SetUp_ShaderResources()
{
...
HRESULT CRock_47::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_47 * CRock_47::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_47* pInstance = new CRock_47(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_47");
...
CGameObject * CRock_47::Clone(void * pArg)
{
	CRock_47* pInstance = new CRock_47(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_47");
		Safe_Release(pInstance);
	}
