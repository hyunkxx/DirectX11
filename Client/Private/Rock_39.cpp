#include "stdafx.h"
#include "..\Public\Rock_39.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_39::CRock_39(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_39::CRock_39(const CRock_39 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_39::Initialize_Prototype()
{
...
HRESULT CRock_39::Initialize(void * pArg)
{
...
void CRock_39::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_39::LateTick(_double TimeDelta)
{
...
HRESULT CRock_39::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_39 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_39::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_39,
...
HRESULT CRock_39::SetUp_ShaderResources()
{
...
HRESULT CRock_39::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_39 * CRock_39::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_39* pInstance = new CRock_39(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_39");
...
CGameObject * CRock_39::Clone(void * pArg)
{
	CRock_39* pInstance = new CRock_39(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_39");
		Safe_Release(pInstance);
	}
