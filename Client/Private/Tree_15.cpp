#include "stdafx.h"
#include "..\Public\Tree_15.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_15::CTree_15(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_15::CTree_15(const CTree_15 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_15::Initialize_Prototype()
{
...
HRESULT CTree_15::Initialize(void * pArg)
{
...
void CTree_15::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_15::LateTick(_double TimeDelta)
{
...
HRESULT CTree_15::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_15 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_15::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_15,
...
HRESULT CTree_15::SetUp_ShaderResources()
{
...
HRESULT CTree_15::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_15 * CTree_15::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_15* pInstance = new CTree_15(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_15");
...
CGameObject * CTree_15::Clone(void * pArg)
{
	CTree_15* pInstance = new CTree_15(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_15");
		Safe_Release(pInstance);
	}
