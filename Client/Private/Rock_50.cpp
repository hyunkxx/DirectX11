#include "stdafx.h"
#include "..\Public\Rock_50.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_50::CRock_50(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_50::CRock_50(const CRock_50 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_50::Initialize_Prototype()
{
...
HRESULT CRock_50::Initialize(void * pArg)
{
...
void CRock_50::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_50::LateTick(_double TimeDelta)
{
...
HRESULT CRock_50::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_50 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_50::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_50,
...
HRESULT CRock_50::SetUp_ShaderResources()
{
...
HRESULT CRock_50::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_50 * CRock_50::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_50* pInstance = new CRock_50(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_50");
...
CGameObject * CRock_50::Clone(void * pArg)
{
	CRock_50* pInstance = new CRock_50(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_50");
		Safe_Release(pInstance);
	}
