#include "stdafx.h"
#include "..\Public\Tree_16.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_16::CTree_16(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_16::CTree_16(const CTree_16 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_16::Initialize_Prototype()
{
...
HRESULT CTree_16::Initialize(void * pArg)
{
...
void CTree_16::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_16::LateTick(_double TimeDelta)
{
...
HRESULT CTree_16::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_16 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_16::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_16,
...
HRESULT CTree_16::SetUp_ShaderResources()
{
...
HRESULT CTree_16::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_16 * CTree_16::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_16* pInstance = new CTree_16(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_16");
...
CGameObject * CTree_16::Clone(void * pArg)
{
	CTree_16* pInstance = new CTree_16(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_16");
		Safe_Release(pInstance);
	}
