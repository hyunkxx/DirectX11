#include "stdafx.h"
#include "..\Public\Rock_37.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_37::CRock_37(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_37::CRock_37(const CRock_37 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_37::Initialize_Prototype()
{
...
HRESULT CRock_37::Initialize(void * pArg)
{
...
void CRock_37::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_37::LateTick(_double TimeDelta)
{
...
HRESULT CRock_37::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_37 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_37::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_37,
...
HRESULT CRock_37::SetUp_ShaderResources()
{
...
HRESULT CRock_37::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_37 * CRock_37::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_37* pInstance = new CRock_37(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_37");
...
CGameObject * CRock_37::Clone(void * pArg)
{
	CRock_37* pInstance = new CRock_37(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_37");
		Safe_Release(pInstance);
	}
