#include "stdafx.h"
#include "..\Public\Rock_40.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_40::CRock_40(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_40::CRock_40(const CRock_40 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_40::Initialize_Prototype()
{
...
HRESULT CRock_40::Initialize(void * pArg)
{
...
void CRock_40::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_40::LateTick(_double TimeDelta)
{
...
HRESULT CRock_40::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_40 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_40::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_40,
...
HRESULT CRock_40::SetUp_ShaderResources()
{
...
HRESULT CRock_40::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_40 * CRock_40::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_40* pInstance = new CRock_40(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_40");
...
CGameObject * CRock_40::Clone(void * pArg)
{
	CRock_40* pInstance = new CRock_40(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_40");
		Safe_Release(pInstance);
	}
