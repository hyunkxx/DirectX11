#include "stdafx.h"
#include "..\Public\Rock_16.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_16::CRock_16(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_16::CRock_16(const CRock_16 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_16::Initialize_Prototype()
{
...
HRESULT CRock_16::Initialize(void * pArg)
{
...
void CRock_16::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_16::LateTick(_double TimeDelta)
{
...
HRESULT CRock_16::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_16 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_16::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_16,
...
HRESULT CRock_16::SetUp_ShaderResources()
{
...
HRESULT CRock_16::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_16 * CRock_16::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_16* pInstance = new CRock_16(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_16");
...
CGameObject * CRock_16::Clone(void * pArg)
{
	CRock_16* pInstance = new CRock_16(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_16");
		Safe_Release(pInstance);
	}
