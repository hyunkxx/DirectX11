#include "stdafx.h"
#include "..\Public\Rock_51.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_51::CRock_51(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_51::CRock_51(const CRock_51 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_51::Initialize_Prototype()
{
...
HRESULT CRock_51::Initialize(void * pArg)
{
...
void CRock_51::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_51::LateTick(_double TimeDelta)
{
...
HRESULT CRock_51::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_51 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_51::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_51,
...
HRESULT CRock_51::SetUp_ShaderResources()
{
...
HRESULT CRock_51::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_51 * CRock_51::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_51* pInstance = new CRock_51(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_51");
...
CGameObject * CRock_51::Clone(void * pArg)
{
	CRock_51* pInstance = new CRock_51(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_51");
		Safe_Release(pInstance);
	}
