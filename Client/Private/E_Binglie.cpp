...
CE_Binglie::CE_Binglie(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CCharacter(pDevice, pContext)
{
}

CE_Binglie::CE_Binglie(const CE_Binglie & rhs)
	: CCharacter(rhs)
{
}

HRESULT CE_Binglie::Initialize_Prototype()
{
...
HRESULT CE_Binglie::Initialize(void * pArg)
{
	...
	m_pEchoSystem->Register_EchoPtr(CEchoSystem::EC_GLACIO_PREDATOR, this);
...
void CE_Binglie::PreTick(_double TimeDelta)
{
...
void CE_Binglie::Tick(_double TimeDelta)
{
...
void CE_Binglie::LateTick(_double TimeDelta)
{
...
HRESULT CE_Binglie::RenderShadow()
{
	if (false == m_bRender)
		return S_OK;
...
void CE_Binglie::RenderGUI()
{
}

HRESULT CE_Binglie::Add_Components()
{
	/* For.Com_Renderer*/
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, DMODEL::DMD_ECHO_BINGLIE,
...
HRESULT CE_Binglie::Init_State(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	ZeroMemory(&m_tCurState, sizeof(SINGLESTATE));

	// 로드하는 코드
	_tchar szBuffer[MAX_PATH];
	wsprintf(szBuffer, TEXT("../../Data/CharState/Echos/Binglie_8.state"));
...
void CE_Binglie::Release_Reloadable()
{
...
void CE_Binglie::Shot_MissileKey(_uint iMissilePoolID, _uint iEffectBoneID)
{
	_vector vInitPos;
	if (0 != iEffectBoneID)
	{
...
void CE_Binglie::Shot_DissolveKey(_bool bDissolveType, _float fDissolveSpeed)
{
...
void CE_Binglie::Shot_Echo(CTransform * pTransform, CCharacter * pTarget, _uint iNaviCellID)
{
	SetState(ACTIVE);
...
void CE_Binglie::Change_Target(CCharacter * pActiveCharacter)
{
...
HRESULT CE_Binglie::Setup_ShadowShaderResource()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
void CE_Binglie::Tick_State(_double TimeDelta)
{
	//
...
HRESULT CE_Binglie::Init_EffectBones()
{
...
void CE_Binglie::Update_EffectBones()
{
...
CE_Binglie * CE_Binglie::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CE_Binglie* pInstance = new CE_Binglie(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CE_Binglie");
...
CGameObject * CE_Binglie::Clone(void * pArg)
{
	CE_Binglie* pInstance = new CE_Binglie(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CE_Binglie");
		Safe_Release(pInstance);
	}
...
void CE_Binglie::OnCollisionEnter(CCollider * src, CCollider * dest)
{
	CGameMode* pGM = CGameMode::GetInstance();
...
void CE_Binglie::OnCollisionStay(CCollider * src, CCollider * dest)
{
	CCharacter* pOpponent = dynamic_cast<CCharacter*>(dest->GetOwner());
...
void CE_Binglie::OnCollisionExit(CCollider * src, CCollider * dest)
{
}
