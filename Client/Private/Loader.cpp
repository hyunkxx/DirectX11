...
#pragma region GAMEOBJECTS
	...
	if (FAILED(pGameInstance->Add_Prototype(OBJECT::LOBBY_CHARACTER, CLobbyCharacter::Create(m_pDevice, m_pContext, DMODEL::DMD_PLAYERGIRL_MODEL, DMODEL::DMD_LOBBY_CHARACTER_MODEL))))
		return E_FAIL;
