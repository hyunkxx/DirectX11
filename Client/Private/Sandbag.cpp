...
HRESULT CSandbag::Init_States(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
...
void CSandbag::Shot_EffectKey(_tchar * szEffectTag/* szTag1*/, _uint EffectBoneID /* iInt0 */, _uint iEffectTypeID, _bool bTracking/*iInt1*/)
{
...
void CSandbag::Shot_MissileKey(_uint iMissilePoolID, _uint iEffectBoneID)
{
...
void CSandbag::Shot_OBBKey(_bool bOBB, _uint iAttackInfoID)
{
...
void CSandbag::Shot_PriorityKey(_uint iLeavePriority)
{
	m_tCurState.iLeavePriority = iLeavePriority;
}

void CSandbag::SetUp_State()
{
	// 키 리셋
...
void CSandbag::Change_Target(CCharacter * pActiveCharacter)
{
	m_pTarget = pActiveCharacter;
	m_pTargetTransform = m_pTarget->GetTransform();
}

void CSandbag::Find_Target()
{
...
void CSandbag::Init_AttackInfos()
{
...
void CSandbag::Apply_CoolTime(_double TimeDelta)
{
...
void CSandbag::Select_State(_double TimeDelta)
{
	...
	case Client::CSandbag::AI_ATTACK:
		...
		break;
	case Client::CSandbag::AI_CHASE:
		m_Scon.iNextState = IS_RUN;
		break;
	case Client::CSandbag::AI_STAY:
...
void CSandbag::Tick_State(_double TimeDelta)
{
	//
...
void CSandbag::On_Hit(CCharacter * pChar, TAGATTACK * pAttackInfo, _float fAttackPoint, _float3 * pEffPos, _float fCritRate, _float fCritDMG)
{
	// 피격 이펙트 출력
...
HRESULT CSandbag::Init_EffectBones()
{
...
void CSandbag::Update_EffectBones()
{
