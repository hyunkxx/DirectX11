#include "stdafx.h"
#include "..\Public\Tree_14.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_14::CTree_14(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_14::CTree_14(const CTree_14 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_14::Initialize_Prototype()
{
...
HRESULT CTree_14::Initialize(void * pArg)
{
...
void CTree_14::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_14::LateTick(_double TimeDelta)
{
...
HRESULT CTree_14::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_14 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_14::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_14,
...
HRESULT CTree_14::SetUp_ShaderResources()
{
...
HRESULT CTree_14::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_14 * CTree_14::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_14* pInstance = new CTree_14(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_14");
...
CGameObject * CTree_14::Clone(void * pArg)
{
	CTree_14* pInstance = new CTree_14(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_14");
		Safe_Release(pInstance);
	}
