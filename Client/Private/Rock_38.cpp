#include "stdafx.h"
#include "..\Public\Rock_38.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_38::CRock_38(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_38::CRock_38(const CRock_38 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_38::Initialize_Prototype()
{
...
HRESULT CRock_38::Initialize(void * pArg)
{
...
void CRock_38::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_38::LateTick(_double TimeDelta)
{
...
HRESULT CRock_38::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_38 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_38::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_38,
...
HRESULT CRock_38::SetUp_ShaderResources()
{
...
HRESULT CRock_38::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_38 * CRock_38::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_38* pInstance = new CRock_38(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_38");
...
CGameObject * CRock_38::Clone(void * pArg)
{
	CRock_38* pInstance = new CRock_38(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_38");
		Safe_Release(pInstance);
	}
