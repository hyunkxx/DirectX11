#include "stdafx.h"
#include "..\Public\Tree_21.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_21::CTree_21(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_21::CTree_21(const CTree_21 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_21::Initialize_Prototype()
{
...
HRESULT CTree_21::Initialize(void * pArg)
{
...
void CTree_21::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_21::LateTick(_double TimeDelta)
{
...
HRESULT CTree_21::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_21 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_21::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_21,
...
HRESULT CTree_21::SetUp_ShaderResources()
{
...
HRESULT CTree_21::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_21 * CTree_21::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_21* pInstance = new CTree_21(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_21");
...
CGameObject * CTree_21::Clone(void * pArg)
{
	CTree_21* pInstance = new CTree_21(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_21");
		Safe_Release(pInstance);
	}
