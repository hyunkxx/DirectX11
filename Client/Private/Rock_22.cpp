#include "stdafx.h"
#include "..\Public\Rock_22.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_22::CRock_22(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_22::CRock_22(const CRock_22 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_22::Initialize_Prototype()
{
...
HRESULT CRock_22::Initialize(void * pArg)
{
...
void CRock_22::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_22::LateTick(_double TimeDelta)
{
...
HRESULT CRock_22::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_22 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_22::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_22,
...
HRESULT CRock_22::SetUp_ShaderResources()
{
...
HRESULT CRock_22::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_22 * CRock_22::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_22* pInstance = new CRock_22(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_22");
...
CGameObject * CRock_22::Clone(void * pArg)
{
	CRock_22* pInstance = new CRock_22(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_22");
		Safe_Release(pInstance);
	}
