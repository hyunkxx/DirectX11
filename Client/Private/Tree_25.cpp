#include "stdafx.h"
#include "..\Public\Tree_25.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_25::CTree_25(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_25::CTree_25(const CTree_25 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_25::Initialize_Prototype()
{
...
HRESULT CTree_25::Initialize(void * pArg)
{
...
void CTree_25::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_25::LateTick(_double TimeDelta)
{
...
HRESULT CTree_25::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_25 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_25::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_25,
...
HRESULT CTree_25::SetUp_ShaderResources()
{
...
HRESULT CTree_25::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_25 * CTree_25::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_25* pInstance = new CTree_25(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_25");
...
CGameObject * CTree_25::Clone(void * pArg)
{
	CTree_25* pInstance = new CTree_25(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_25");
		Safe_Release(pInstance);
	}
