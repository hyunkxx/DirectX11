#include "stdafx.h"
#include "..\Public\Tree_19.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_19::CTree_19(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_19::CTree_19(const CTree_19 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_19::Initialize_Prototype()
{
...
HRESULT CTree_19::Initialize(void * pArg)
{
...
void CTree_19::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_19::LateTick(_double TimeDelta)
{
...
HRESULT CTree_19::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_19 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_19::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_19,
...
HRESULT CTree_19::SetUp_ShaderResources()
{
...
HRESULT CTree_19::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_19 * CTree_19::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_19* pInstance = new CTree_19(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_19");
...
CGameObject * CTree_19::Clone(void * pArg)
{
	CTree_19* pInstance = new CTree_19(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_19");
		Safe_Release(pInstance);
	}
