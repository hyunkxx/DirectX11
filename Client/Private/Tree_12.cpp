#include "stdafx.h"
#include "..\Public\Tree_12.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_12::CTree_12(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_12::CTree_12(const CTree_12 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_12::Initialize_Prototype()
{
...
HRESULT CTree_12::Initialize(void * pArg)
{
...
void CTree_12::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_12::LateTick(_double TimeDelta)
{
...
HRESULT CTree_12::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_12 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_12::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_12,
...
HRESULT CTree_12::SetUp_ShaderResources()
{
...
HRESULT CTree_12::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_12 * CTree_12::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_12* pInstance = new CTree_12(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_12");
...
CGameObject * CTree_12::Clone(void * pArg)
{
	CTree_12* pInstance = new CTree_12(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_12");
		Safe_Release(pInstance);
	}
