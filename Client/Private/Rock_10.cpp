#include "stdafx.h"
#include "..\Public\Rock_10.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_10::CRock_10(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_10::CRock_10(const CRock_10 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_10::Initialize_Prototype()
{
...
HRESULT CRock_10::Initialize(void * pArg)
{
...
void CRock_10::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_10::LateTick(_double TimeDelta)
{
...
HRESULT CRock_10::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_10 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_10::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_10,
...
HRESULT CRock_10::SetUp_ShaderResources()
{
...
HRESULT CRock_10::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_10 * CRock_10::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_10* pInstance = new CRock_10(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_10");
...
CGameObject * CRock_10::Clone(void * pArg)
{
	CRock_10* pInstance = new CRock_10(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_10");
		Safe_Release(pInstance);
	}
