#include "stdafx.h"
#include "..\Public\Rock_32.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_32::CRock_32(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_32::CRock_32(const CRock_32 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_32::Initialize_Prototype()
{
...
HRESULT CRock_32::Initialize(void * pArg)
{
...
void CRock_32::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_32::LateTick(_double TimeDelta)
{
...
HRESULT CRock_32::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_32 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_32::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_32,
...
HRESULT CRock_32::SetUp_ShaderResources()
{
...
HRESULT CRock_32::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_32 * CRock_32::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_32* pInstance = new CRock_32(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_32");
...
CGameObject * CRock_32::Clone(void * pArg)
{
	CRock_32* pInstance = new CRock_32(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_32");
		Safe_Release(pInstance);
	}
