#include "stdafx.h"
#include "..\Public\Tree_13.h"

#include "GameInstance.h"
#include "GameMode.h"

CTree_13::CTree_13(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CTree_13::CTree_13(const CTree_13 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree_13::Initialize_Prototype()
{
...
HRESULT CTree_13::Initialize(void * pArg)
{
...
void CTree_13::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CTree_13::LateTick(_double TimeDelta)
{
...
HRESULT CTree_13::Load_EditionColor(const _tchar * pEditionColorFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CTree_13 : EditionColor");
		return E_FAIL;
	}
...
HRESULT CTree_13::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_TREE_13,
...
HRESULT CTree_13::SetUp_ShaderResources()
{
...
HRESULT CTree_13::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CTree_13 * CTree_13::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CTree_13* pInstance = new CTree_13(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CTree_13");
...
CGameObject * CTree_13::Clone(void * pArg)
{
	CTree_13* pInstance = new CTree_13(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CTree_13");
		Safe_Release(pInstance);
	}
