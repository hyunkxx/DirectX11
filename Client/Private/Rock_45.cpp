#include "stdafx.h"
#include "..\Public\Rock_45.h"

#include "GameInstance.h"
#include "GameMode.h"

CRock_45::CRock_45(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CGameObject(pDevice, pContext)
{
}

CRock_45::CRock_45(const CRock_45 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock_45::Initialize_Prototype()
{
...
HRESULT CRock_45::Initialize(void * pArg)
{
...
void CRock_45::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);
}

void CRock_45::LateTick(_double TimeDelta)
{
...
HRESULT CRock_45::Load_DiffuseTexID(const _tchar * pDiffuseTexIDFilePath)
{
	...
	{
		MSG_BOX("Failed to Load Data in CRock_45 : DiffuseTexID");
		return E_FAIL;
	}
...
HRESULT CRock_45::Add_Components()
{
	/* For.Com_Renderer*/
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_ANYWHERE, SMODEL::SMD_ROCK_45,
...
HRESULT CRock_45::SetUp_ShaderResources()
{
...
HRESULT CRock_45::SetUp_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
...
CRock_45 * CRock_45::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CRock_45* pInstance = new CRock_45(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Create : CRock_45");
...
CGameObject * CRock_45::Clone(void * pArg)
{
	CRock_45* pInstance = new CRock_45(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Clone : CRock_45");
		Safe_Release(pInstance);
	}
