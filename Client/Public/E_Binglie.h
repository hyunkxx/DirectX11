...
private:
	CE_Binglie(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CE_Binglie(const CE_Binglie& rhs);
	virtual ~CE_Binglie() = default;
...
public:
	static CE_Binglie* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	...
	void CE_Binglie::OnCollisionEnter(CCollider * src, CCollider * dest) override;
	void CE_Binglie::OnCollisionStay(CCollider * src, CCollider * dest) override;
	void CE_Binglie::OnCollisionExit(CCollider * src, CCollider * dest) override;
