...
class CRock_28 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_28(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_28(const CRock_28& rhs);
	virtual ~CRock_28() = default;
...
public:
	static CRock_28* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
