...
class CTree_19 : public CGameObject
{
private:
	CTree_19(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_19(const CTree_19& rhs);
	virtual ~CTree_19() = default;
...
public:
	static CTree_19* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
