...
class CTree_5 : public CGameObject
{
private:
	CTree_5(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_5(const CTree_5& rhs);
	virtual ~CTree_5() = default;
...
public:
	static CTree_5* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
