...
class CTree_21 : public CGameObject
{
private:
	CTree_21(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_21(const CTree_21& rhs);
	virtual ~CTree_21() = default;
...
public:
	static CTree_21* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
