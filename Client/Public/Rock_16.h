...
class CRock_16 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_16(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_16(const CRock_16& rhs);
	virtual ~CRock_16() = default;
...
public:
	static CRock_16* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
