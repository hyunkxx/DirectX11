...
private:
	CE_AWukaka(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CE_AWukaka(const CE_AWukaka& rhs);
	virtual ~CE_AWukaka() = default;
...
public:
	static CE_AWukaka* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	...
	void CE_AWukaka::OnCollisionEnter(CCollider * src, CCollider * dest) override;
	void CE_AWukaka::OnCollisionStay(CCollider * src, CCollider * dest) override;
	void CE_AWukaka::OnCollisionExit(CCollider * src, CCollider * dest) override;
