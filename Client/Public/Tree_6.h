...
class CTree_6 : public CGameObject
{
private:
	CTree_6(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_6(const CTree_6& rhs);
	virtual ~CTree_6() = default;
...
public:
	static CTree_6* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
