...
class CRock_33 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_33(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_33(const CRock_33& rhs);
	virtual ~CRock_33() = default;
...
public:
	static CRock_33* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
