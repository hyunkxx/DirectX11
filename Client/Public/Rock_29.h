...
class CRock_29 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_29(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_29(const CRock_29& rhs);
	virtual ~CRock_29() = default;
...
public:
	static CRock_29* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
