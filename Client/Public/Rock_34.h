...
class CRock_34 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_34(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_34(const CRock_34& rhs);
	virtual ~CRock_34() = default;
...
public:
	static CRock_34* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
