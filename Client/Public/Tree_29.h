...
class CTree_29 : public CGameObject
{
private:
	CTree_29(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_29(const CTree_29& rhs);
	virtual ~CTree_29() = default;
...
public:
	static CTree_29* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
