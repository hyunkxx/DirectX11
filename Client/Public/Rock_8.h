...
class CRock_8 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_8(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_8(const CRock_8& rhs);
	virtual ~CRock_8() = default;
...
public:
	static CRock_8* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
