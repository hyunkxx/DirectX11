...
class CTree_14 : public CGameObject
{
private:
	CTree_14(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_14(const CTree_14& rhs);
	virtual ~CTree_14() = default;
...
public:
	static CTree_14* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
