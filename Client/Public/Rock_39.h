...
class CRock_39 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_39(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_39(const CRock_39& rhs);
	virtual ~CRock_39() = default;
...
public:
	static CRock_39* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
