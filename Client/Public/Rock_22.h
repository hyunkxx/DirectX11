...
class CRock_22 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_22(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_22(const CRock_22& rhs);
	virtual ~CRock_22() = default;
...
public:
	static CRock_22* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
