...
class CTree_17 : public CGameObject
{
private:
	CTree_17(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_17(const CTree_17& rhs);
	virtual ~CTree_17() = default;
...
public:
	static CTree_17* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
