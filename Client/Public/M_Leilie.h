...
private:
	CM_Leilie(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CM_Leilie(const CM_Leilie& rhs);
	virtual ~CM_Leilie() = default;
...
public:
	static CM_Leilie* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	...
	void CM_Leilie::OnCollisionEnter(CCollider * src, CCollider * dest) override;
	void CM_Leilie::OnCollisionStay(CCollider * src, CCollider * dest) override;
	void CM_Leilie::OnCollisionExit(CCollider * src, CCollider * dest) override;
