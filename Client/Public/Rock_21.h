...
class CRock_21 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_21(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_21(const CRock_21& rhs);
	virtual ~CRock_21() = default;
...
public:
	static CRock_21* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
