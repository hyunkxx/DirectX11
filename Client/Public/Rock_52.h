...
class CRock_52 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_52(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_52(const CRock_52& rhs);
	virtual ~CRock_52() = default;
...
public:
	static CRock_52* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
