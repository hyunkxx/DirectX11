...
class CRock_7 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_7(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_7(const CRock_7& rhs);
	virtual ~CRock_7() = default;
...
public:
	static CRock_7* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
