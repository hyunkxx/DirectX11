...
class CTree_11 : public CGameObject
{
private:
	CTree_11(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_11(const CTree_11& rhs);
	virtual ~CTree_11() = default;
...
public:
	static CTree_11* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
