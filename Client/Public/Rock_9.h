...
class CRock_9 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_9(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_9(const CRock_9& rhs);
	virtual ~CRock_9() = default;
...
public:
	static CRock_9* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
