...
class CRock_35 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_35(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_35(const CRock_35& rhs);
	virtual ~CRock_35() = default;
...
public:
	static CRock_35* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
