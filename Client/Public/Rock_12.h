...
class CRock_12 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_12(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_12(const CRock_12& rhs);
	virtual ~CRock_12() = default;
...
public:
	static CRock_12* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
