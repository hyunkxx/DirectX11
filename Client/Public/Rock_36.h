...
class CRock_36 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_36(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_36(const CRock_36& rhs);
	virtual ~CRock_36() = default;
...
public:
	static CRock_36* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
