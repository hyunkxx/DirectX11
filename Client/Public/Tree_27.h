...
class CTree_27 : public CGameObject
{
private:
	CTree_27(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_27(const CTree_27& rhs);
	virtual ~CTree_27() = default;
...
public:
	static CTree_27* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
