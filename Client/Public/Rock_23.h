...
class CRock_23 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_23(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_23(const CRock_23& rhs);
	virtual ~CRock_23() = default;
...
public:
	static CRock_23* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
