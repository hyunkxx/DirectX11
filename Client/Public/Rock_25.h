...
class CRock_25 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_25(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_25(const CRock_25& rhs);
	virtual ~CRock_25() = default;
...
public:
	static CRock_25* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
