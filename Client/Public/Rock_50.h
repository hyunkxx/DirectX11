...
class CRock_50 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_50(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_50(const CRock_50& rhs);
	virtual ~CRock_50() = default;
...
public:
	static CRock_50* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
