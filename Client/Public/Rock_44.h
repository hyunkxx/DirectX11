...
class CRock_44 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_44(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_44(const CRock_44& rhs);
	virtual ~CRock_44() = default;
...
public:
	static CRock_44* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
