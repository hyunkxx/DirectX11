...
class CRock_18 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_18(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_18(const CRock_18& rhs);
	virtual ~CRock_18() = default;
...
public:
	static CRock_18* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
