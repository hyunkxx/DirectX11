...
class CRock_40 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_40(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_40(const CRock_40& rhs);
	virtual ~CRock_40() = default;
...
public:
	static CRock_40* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
