...
class CTree_26 : public CGameObject
{
private:
	CTree_26(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_26(const CTree_26& rhs);
	virtual ~CTree_26() = default;
...
public:
	static CTree_26* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
