...
class CTree_2 : public CGameObject
{
private:
	CTree_2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_2(const CTree_2& rhs);
	virtual ~CTree_2() = default;
...
public:
	static CTree_2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
