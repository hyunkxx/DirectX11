...
class CRock_51 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_51(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_51(const CRock_51& rhs);
	virtual ~CRock_51() = default;
...
public:
	static CRock_51* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
