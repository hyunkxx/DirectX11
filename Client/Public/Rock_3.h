...
class CRock_3 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_3(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_3(const CRock_3& rhs);
...
public:
	static CRock_3* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
