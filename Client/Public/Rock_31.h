...
class CRock_31 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_31(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_31(const CRock_31& rhs);
	virtual ~CRock_31() = default;
...
public:
	static CRock_31* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
