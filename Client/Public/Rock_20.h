...
class CRock_20 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_20(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_20(const CRock_20& rhs);
	virtual ~CRock_20() = default;
...
public:
	static CRock_20* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
