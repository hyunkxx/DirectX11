...
class CTree_24 : public CGameObject
{
private:
	CTree_24(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_24(const CTree_24& rhs);
	virtual ~CTree_24() = default;
...
public:
	static CTree_24* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
