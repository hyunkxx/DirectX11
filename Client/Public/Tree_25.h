...
class CTree_25 : public CGameObject
{
private:
	CTree_25(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_25(const CTree_25& rhs);
	virtual ~CTree_25() = default;
...
public:
	static CTree_25* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
