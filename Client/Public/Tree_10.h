...
class CTree_10 : public CGameObject
{
private:
	CTree_10(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_10(const CTree_10& rhs);
	virtual ~CTree_10() = default;
...
public:
	static CTree_10* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
