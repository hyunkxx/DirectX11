...
class CRock_38 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_38(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_38(const CRock_38& rhs);
	virtual ~CRock_38() = default;
...
public:
	static CRock_38* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
