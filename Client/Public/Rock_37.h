...
class CRock_37 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_37(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_37(const CRock_37& rhs);
	virtual ~CRock_37() = default;
...
public:
	static CRock_37* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
