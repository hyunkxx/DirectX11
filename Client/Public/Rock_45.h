...
class CRock_45 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_45(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_45(const CRock_45& rhs);
	virtual ~CRock_45() = default;
...
public:
	static CRock_45* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
