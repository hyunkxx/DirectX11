...
class CTree_22 : public CGameObject
{
private:
	CTree_22(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_22(const CTree_22& rhs);
	virtual ~CTree_22() = default;
...
public:
	static CTree_22* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
