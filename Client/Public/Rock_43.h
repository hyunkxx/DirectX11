...
class CRock_43 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_43(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_43(const CRock_43& rhs);
	virtual ~CRock_43() = default;
...
public:
	static CRock_43* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
