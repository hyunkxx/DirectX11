...
class CRock_32 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_32(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_32(const CRock_32& rhs);
	virtual ~CRock_32() = default;
...
public:
	static CRock_32* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
