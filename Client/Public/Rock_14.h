...
class CRock_14 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_14(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_14(const CRock_14& rhs);
	virtual ~CRock_14() = default;
...
public:
	static CRock_14* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
