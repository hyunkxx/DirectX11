...
class CRock_6 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_6(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_6(const CRock_6& rhs);
	virtual ~CRock_6() = default;
...
public:
	static CRock_6* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
