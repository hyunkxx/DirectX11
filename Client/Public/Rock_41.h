...
class CRock_41 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_41(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_41(const CRock_41& rhs);
	virtual ~CRock_41() = default;
...
public:
	static CRock_41* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
