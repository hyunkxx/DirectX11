...
class CRock_46 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_46(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_46(const CRock_46& rhs);
	virtual ~CRock_46() = default;
...
public:
	static CRock_46* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
