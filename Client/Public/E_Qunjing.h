...
private:
	CE_Qunjing(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CE_Qunjing(const CE_Qunjing& rhs);
	virtual ~CE_Qunjing() = default;
...
public:
	...
	virtual void Get_AttackInfo(_uint iAttackID, TAGATTACK* pAttackInfoOut, _float* pAttackOut) override
	{
		...
		*pAttackOut = m_pEchoSystem->GetEcho(CEchoSystem::EC_ELITE_STONE).fAttack;
	}
...
public:
	static CE_Qunjing* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	...
	void CE_Qunjing::OnCollisionEnter(CCollider * src, CCollider * dest) override;
	void CE_Qunjing::OnCollisionStay(CCollider * src, CCollider * dest) override;
	void CE_Qunjing::OnCollisionExit(CCollider * src, CCollider * dest) override;
