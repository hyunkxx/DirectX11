...
class CRock_27 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_27(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_27(const CRock_27& rhs);
	virtual ~CRock_27() = default;
...
public:
	static CRock_27* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
