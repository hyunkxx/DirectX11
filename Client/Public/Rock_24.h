...
class CRock_24 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_24(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_24(const CRock_24& rhs);
	virtual ~CRock_24() = default;
...
public:
	static CRock_24* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
