...
class CRock_0 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_0(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_0(const CRock_0& rhs);
	virtual ~CRock_0() = default;
...
public:
	static CRock_0* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
