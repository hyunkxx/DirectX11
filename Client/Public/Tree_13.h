...
class CTree_13 : public CGameObject
{
private:
	CTree_13(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_13(const CTree_13& rhs);
	virtual ~CTree_13() = default;
...
public:
	static CTree_13* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
