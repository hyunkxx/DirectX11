...
class CRock_11 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_11(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_11(const CRock_11& rhs);
	virtual ~CRock_11() = default;
...
public:
	static CRock_11* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
