...
class CRock_30 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_30(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_30(const CRock_30& rhs);
	virtual ~CRock_30() = default;
...
public:
	static CRock_30* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
