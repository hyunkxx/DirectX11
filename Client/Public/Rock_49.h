...
class CRock_49 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_49(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_49(const CRock_49& rhs);
	virtual ~CRock_49() = default;
...
public:
	static CRock_49* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
