...
class CTree_9 : public CGameObject
{
private:
	CTree_9(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_9(const CTree_9& rhs);
	virtual ~CTree_9() = default;
...
public:
	static CTree_9* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
