...
class CTree_28 : public CGameObject
{
private:
	CTree_28(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_28(const CTree_28& rhs);
	virtual ~CTree_28() = default;
...
public:
	static CTree_28* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
