...
class CTree_16 : public CGameObject
{
private:
	CTree_16(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_16(const CTree_16& rhs);
	virtual ~CTree_16() = default;
...
public:
	static CTree_16* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
