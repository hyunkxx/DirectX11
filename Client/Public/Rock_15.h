...
class CRock_15 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_15(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_15(const CRock_15& rhs);
	virtual ~CRock_15() = default;
...
public:
	static CRock_15* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
