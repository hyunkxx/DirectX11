...
class CRock_10 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_10(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_10(const CRock_10& rhs);
	virtual ~CRock_10() = default;
...
public:
	static CRock_10* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
