...
class CRock_19 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_19(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_19(const CRock_19& rhs);
	virtual ~CRock_19() = default;
...
public:
	static CRock_19* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
