...
class CRock_13 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_13(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_13(const CRock_13& rhs);
	virtual ~CRock_13() = default;
...
public:
	static CRock_13* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
