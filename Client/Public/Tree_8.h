...
class CTree_8 : public CGameObject
{
private:
	CTree_8(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_8(const CTree_8& rhs);
	virtual ~CTree_8() = default;
...
public:
	static CTree_8* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
