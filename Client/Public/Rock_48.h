...
class CRock_48 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_48(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_48(const CRock_48& rhs);
	virtual ~CRock_48() = default;
...
public:
	static CRock_48* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
