...
class CRock_47 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_47(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_47(const CRock_47& rhs);
	virtual ~CRock_47() = default;
...
public:
	static CRock_47* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
