...
class CTree_4 : public CGameObject
{
private:
	CTree_4(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_4(const CTree_4& rhs);
	virtual ~CTree_4() = default;
...
public:
	static CTree_4* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
