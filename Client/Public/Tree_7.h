...
class CTree_7 : public CGameObject
{
private:
	CTree_7(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_7(const CTree_7& rhs);
	virtual ~CTree_7() = default;
...
public:
	static CTree_7* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
