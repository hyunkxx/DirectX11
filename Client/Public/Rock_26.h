...
class CRock_26 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_26(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_26(const CRock_26& rhs);
	virtual ~CRock_26() = default;
...
public:
	static CRock_26* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
