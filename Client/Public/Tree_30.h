...
class CTree_30 : public CGameObject
{
private:
	CTree_30(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_30(const CTree_30& rhs);
	virtual ~CTree_30() = default;
...
public:
	static CTree_30* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
