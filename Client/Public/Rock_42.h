...
class CRock_42 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_42(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_42(const CRock_42& rhs);
	virtual ~CRock_42() = default;
...
public:
	static CRock_42* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
