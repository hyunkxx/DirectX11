...
class CRock_17 : public CGameObject
{
public:
	enum ROCK_DIFFUSE_KINDS { RD_1, RD_2, RD_3, RD_4, RD_END };

private:
	CRock_17(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRock_17(const CRock_17& rhs);
	virtual ~CRock_17() = default;
...
public:
	static CRock_17* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
