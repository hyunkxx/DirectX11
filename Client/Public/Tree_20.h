...
class CTree_20 : public CGameObject
{
private:
	CTree_20(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_20(const CTree_20& rhs);
	virtual ~CTree_20() = default;
...
public:
	static CTree_20* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
