...
class CTree_15 : public CGameObject
{
private:
	CTree_15(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_15(const CTree_15& rhs);
	virtual ~CTree_15() = default;
...
public:
	static CTree_15* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
