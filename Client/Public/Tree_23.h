...
class CTree_23 : public CGameObject
{
private:
	CTree_23(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_23(const CTree_23& rhs);
	virtual ~CTree_23() = default;
...
public:
	static CTree_23* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
