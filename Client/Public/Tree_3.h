...
class CTree_3 : public CGameObject
{
private:
	CTree_3(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_3(const CTree_3& rhs);
	virtual ~CTree_3() = default;
...
public:
	static CTree_3* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
