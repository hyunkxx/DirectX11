...
class CTree_18 : public CGameObject
{
private:
	CTree_18(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTree_18(const CTree_18& rhs);
	virtual ~CTree_18() = default;
...
public:
	static CTree_18* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
