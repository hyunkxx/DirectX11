...
private:
	CE_FHuxiuxiu(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CE_FHuxiuxiu(const CE_FHuxiuxiu& rhs);
	virtual ~CE_FHuxiuxiu() = default;
...
public:
	...
	virtual void Get_AttackInfo(_uint iAttackID, TAGATTACK* pAttackInfoOut, _float* pAttackOut) override
	{
		...
		*pAttackOut = m_pEchoSystem->GetEcho(CEchoSystem::EC_WHOOSH).fAttack;
	}
...
public:
	static CE_FHuxiuxiu* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	...
	void CE_FHuxiuxiu::OnCollisionEnter(CCollider * src, CCollider * dest) override;
	void CE_FHuxiuxiu::OnCollisionStay(CCollider * src, CCollider * dest) override;
	void CE_FHuxiuxiu::OnCollisionExit(CCollider * src, CCollider * dest) override;
