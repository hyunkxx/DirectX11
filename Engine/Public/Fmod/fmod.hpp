...
namespace FMOD
{
    ...
    */
    inline FMOD_RESULT Memory_Initialize    (void *poolmem, int poollen, FMOD_MEMORY_ALLOC_CALLBACK useralloc, FMOD_MEMORY_REALLOC_CALLBACK userrealloc, FMOD_MEMORY_FREE_CALLBACK userfree, FMOD_MEMORYm_eCollType memtypeflags = FMOD_MEMORY_ALL) { return FMOD_Memory_Initialize(poolmem, poollen, useralloc, userrealloc, userfree, memtypeflags); }
    ...
    inline FMOD_RESULT Thread_SetAttributes (FMOD_THREADm_eCollType type, FMOD_THREAD_AFFINITY affinity = FMOD_THREAD_AFFINITY_GROUP_DEFAULT, FMOD_THREAD_PRIORITY priority = FMOD_THREAD_PRIORITY_DEFAULT, FMOD_THREAD_STACK_SIZE stacksize = FMOD_THREAD_STACK_SIZE_DEFAULT) { return FMOD_Thread_SetAttributes(type, affinity, priority, stacksize); }
    ...
    */
    class System
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setCallback             (FMOD_SYSTEM_CALLBACK callback, FMOD_SYSTEM_CALLBACKm_eCollType callbackmask = FMOD_SYSTEM_CALLBACK_ALL);
        ...
        FMOD_RESULT F_API createDSPByType         (FMOD_DSPm_eCollType type, DSP **dsp);
        ...
        FMOD_RESULT F_API getDSPInfoByType        (FMOD_DSPm_eCollType type, const FMOD_DSP_DESCRIPTION **description);
        ...
        // Routing to ports.
        FMOD_RESULT F_API attachChannelGroupToPort   (FMOD_PORTm_eCollType portType, FMOD_PORT_INDEX portIndex, ChannelGroup *channelgroup, bool passThru = false);
    ...
    */
    class Sound
    {
      ...
      public:
        ...
        FMOD_RESULT F_API getFormat              (FMOD_SOUNDm_eCollType *type, FMOD_SOUND_FORMAT *format, int *channels, int *bits);
    ...
    */
    class DSP
    {
      ...
      public:
        ...
        FMOD_RESULT F_API addInput               (DSP *input, DSPConnection **connection = 0, FMOD_DSPCONNECTIONm_eCollType type = FMOD_DSPCONNECTIONm_eCollType_STANDARD);
        ...
        FMOD_RESULT F_API getType                (FMOD_DSPm_eCollType *type);
    ...
    */
    class DSPConnection
    {
      ...
      public:
        ...
        FMOD_RESULT F_API setMixMatrix          (float *matrix, int outchannels, int inchannels, int inchannel_hop = 0);
        FMOD_RESULT F_API getMixMatrix          (float *matrix, int *outchannels, int *inchannels, int inchannel_hop = 0);
        FMOD_RESULT F_API getType               (FMOD_DSPCONNECTIONm_eCollType *type);
