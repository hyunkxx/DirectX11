...
/* https://fmod.com/docs/2.02/api/core-api-common-dsp-effects.html#fmod_dspm_eCollType                                 */
/* ============================================================================================================= */
...
typedef enum
{
    FMOD_DSPm_eCollType_UNKNOWN,
    FMOD_DSPm_eCollType_MIXER,
    FMOD_DSPm_eCollType_OSCILLATOR,
    FMOD_DSPm_eCollType_LOWPASS,
    FMOD_DSPm_eCollType_ITLOWPASS,
    FMOD_DSPm_eCollType_HIGHPASS,
    FMOD_DSPm_eCollType_ECHO,
    FMOD_DSPm_eCollType_FADER,
    FMOD_DSPm_eCollType_FLANGE,
    FMOD_DSPm_eCollType_DISTORTION,
    FMOD_DSPm_eCollType_NORMALIZE,
    FMOD_DSPm_eCollType_LIMITER,
    FMOD_DSPm_eCollType_PARAMEQ,
    FMOD_DSPm_eCollType_PITCHSHIFT,
    FMOD_DSPm_eCollType_CHORUS,
    FMOD_DSPm_eCollType_VSTPLUGIN,
    FMOD_DSPm_eCollType_WINAMPPLUGIN,
    FMOD_DSPm_eCollType_ITECHO,
    FMOD_DSPm_eCollType_COMPRESSOR,
    FMOD_DSPm_eCollType_SFXREVERB,
    FMOD_DSPm_eCollType_LOWPASS_SIMPLE,
    FMOD_DSPm_eCollType_DELAY,
    FMOD_DSPm_eCollType_TREMOLO,
    FMOD_DSPm_eCollType_LADSPAPLUGIN,
    FMOD_DSPm_eCollType_SEND,
    FMOD_DSPm_eCollType_RETURN,
    FMOD_DSPm_eCollType_HIGHPASS_SIMPLE,
    FMOD_DSPm_eCollType_PAN,
    FMOD_DSPm_eCollType_THREE_EQ,
    FMOD_DSPm_eCollType_FFT,
    FMOD_DSPm_eCollType_LOUDNESS_METER,
    FMOD_DSPm_eCollType_ENVELOPEFOLLOWER,
    FMOD_DSPm_eCollType_CONVOLUTIONREVERB,
    FMOD_DSPm_eCollType_CHANNELMIX,
    FMOD_DSPm_eCollType_TRANSCEIVER,
    FMOD_DSPm_eCollType_OBJECTPAN,
    FMOD_DSPm_eCollType_MULTIBAND_EQ,

    FMOD_DSPm_eCollType_MAX,
    FMOD_DSPm_eCollType_FORCEINT = 65536    /* Makes sure this enum is signed 32bit. */
} FMOD_DSPm_eCollType;
...
typedef enum
{
    FMOD_DSP_OSCILLATORm_eCollType,
...
typedef enum FMOD_DSP_MULTIBAND_EQ_FILTERm_eCollType
{
...
} FMOD_DSP_MULTIBAND_EQ_FILTERm_eCollType;
...
} FMOD_DSP_PAN_2D_STEREO_MODEm_eCollType;
...
} FMOD_DSP_PAN_3D_ROLLOFFm_eCollType;
...
} FMOD_DSP_PAN_3D_EXTENT_MODEm_eCollType;
...
} FMOD_DSP_THREE_EQ_CROSSOVERSLOPEm_eCollType;
...
} FMOD_DSP_LOUDNESS_METER_STATEm_eCollType;

typedef struct FMOD_DSP_LOUDNESS_METER_INFOm_eCollType
{
...
} FMOD_DSP_LOUDNESS_METER_INFOm_eCollType;

typedef struct FMOD_DSP_LOUDNESS_METER_WEIGHTINGm_eCollType
{
    float channelweight[32];
} FMOD_DSP_LOUDNESS_METER_WEIGHTINGm_eCollType;
