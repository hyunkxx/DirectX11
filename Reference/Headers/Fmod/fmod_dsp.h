...
typedef enum
{
    FMOD_DSP_PARAMETERm_eCollType_FLOAT,
    FMOD_DSP_PARAMETERm_eCollType_INT,
    FMOD_DSP_PARAMETERm_eCollType_BOOL,
    FMOD_DSP_PARAMETERm_eCollType_DATA,

    FMOD_DSP_PARAMETERm_eCollType_MAX,
    FMOD_DSP_PARAMETERm_eCollType_FORCEINT = 65536
} FMOD_DSP_PARAMETERm_eCollType;

typedef enum
{
    FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType_LINEAR,
    FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType_AUTO,
    FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType_PIECEWISE_LINEAR,

    FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType_FORCEINT = 65536
} FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType;

typedef enum
{
    FMOD_DSP_PARAMETER_DATAm_eCollType_USER = 0,
    FMOD_DSP_PARAMETER_DATAm_eCollType_OVERALLGAIN = -1,
    FMOD_DSP_PARAMETER_DATAm_eCollType_3DATTRIBUTES = -2,
    FMOD_DSP_PARAMETER_DATAm_eCollType_SIDECHAIN = -3,
    FMOD_DSP_PARAMETER_DATAm_eCollType_FFT = -4,
    FMOD_DSP_PARAMETER_DATAm_eCollType_3DATTRIBUTES_MULTI = -5,
    FMOD_DSP_PARAMETER_DATAm_eCollType_ATTENUATION_RANGE = -6,
} FMOD_DSP_PARAMETER_DATAm_eCollType;
...
/*
    DSP Functions
*/
typedef void *      (F_CALL *FMOD_DSP_ALLOC_FUNC)                         (unsigned int size, FMOD_MEMORYm_eCollType type, const char *sourcestr);
typedef void *      (F_CALL *FMOD_DSP_REALLOC_FUNC)                       (void *ptr, unsigned int size, FMOD_MEMORYm_eCollType type, const char *sourcestr);
typedef void        (F_CALL *FMOD_DSP_FREE_FUNC)                          (void *ptr, FMOD_MEMORYm_eCollType type, const char *sourcestr);
...
typedef FMOD_RESULT (F_CALL *FMOD_DSP_PAN_GETROLLOFFGAIN_FUNC)            (FMOD_DSP_STATE *dsp_state, FMOD_DSP_PAN_3D_ROLLOFFm_eCollType rolloff, float distance, float mindistance, float maxdistance, float *gain);
...
{
    FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType               type;
...
{
    FMOD_DSP_PARAMETERm_eCollType type;
    char                    name[16];
    char                    label[16];
...
#define FMOD_DSP_INIT_PARAMDESC_FLOAT(_paramstruct, _name, _label, _description, _min, _max, _defaultval) \
    ...
    (_paramstruct).type         = FMOD_DSP_PARAMETERm_eCollType_FLOAT; \
    ...
    (_paramstruct).floatdesc.mapping.type = FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType_AUTO;
...
#define FMOD_DSP_INIT_PARAMDESC_FLOAT_WITH_MAPPING(_paramstruct, _name, _label, _description, _defaultval, _values, _positions); \
    ...
    (_paramstruct).floatdesc.defaultval   = _defaultval; \
    (_paramstruct).floatdesc.mapping.type = FMOD_DSP_PARAMETER_FLOAT_MAPPINGm_eCollType_PIECEWISE_LINEAR; \
...
#define FMOD_DSP_INIT_PARAMDESC_INT(_paramstruct, _name, _label, _description, _min, _max, _defaultval, _goestoinf, _valuenames) \
    memset(&(_paramstruct), 0, sizeof(_paramstruct)); \
    (_paramstruct).type         = FMOD_DSP_PARAMETERm_eCollType_INT; \
    strncpy((_paramstruct).name,  _name , 15); \
    strncpy((_paramstruct).label, _label, 15); \
    (_paramstruct).description  = _description; \
...
#define FMOD_DSP_INIT_PARAMDESC_BOOL(_paramstruct, _name, _label, _description, _defaultval, _valuenames) \
    memset(&(_paramstruct), 0, sizeof(_paramstruct)); \
    (_paramstruct).type         = FMOD_DSP_PARAMETERm_eCollType_BOOL; \
    strncpy((_paramstruct).name,  _name , 15); \
    strncpy((_paramstruct).label, _label, 15); \
    (_paramstruct).description  = _description; \
...
#define FMOD_DSP_INIT_PARAMDESC_DATA(_paramstruct, _name, _label, _description, _datatype) \
    memset(&(_paramstruct), 0, sizeof(_paramstruct)); \
    (_paramstruct).type         = FMOD_DSP_PARAMETERm_eCollType_DATA; \
    strncpy((_paramstruct).name,  _name , 15); \
    strncpy((_paramstruct).label, _label, 15); \
    (_paramstruct).description  = _description; \
