...
#define FMOD_DEBUGm_eCollType_MEMORY                      0x00000100
#define FMOD_DEBUGm_eCollType_FILE                        0x00000200
#define FMOD_DEBUGm_eCollType_CODEC                       0x00000400
#define FMOD_DEBUGm_eCollType_TRACE                       0x00000800
...
typedef unsigned int FMOD_MEMORYm_eCollType;
...
typedef unsigned int FMOD_SYSTEM_CALLBACKm_eCollType;
...
typedef enum FMOD_THREADm_eCollType
{
    FMOD_THREADm_eCollType_MIXER,
    FMOD_THREADm_eCollType_FEEDER,
    FMOD_THREADm_eCollType_STREAM,
    FMOD_THREADm_eCollType_FILE,
    FMOD_THREADm_eCollType_NONBLOCKING,
    FMOD_THREADm_eCollType_RECORD,
    FMOD_THREADm_eCollType_GEOMETRY,
    FMOD_THREADm_eCollType_PROFILER,
    FMOD_THREADm_eCollType_STUDIO_UPDATE,
    FMOD_THREADm_eCollType_STUDIO_LOAD_BANK,
    FMOD_THREADm_eCollType_STUDIO_LOAD_SAMPLE,
    FMOD_THREADm_eCollType_CONVOLUTION1,
    FMOD_THREADm_eCollType_CONVOLUTION2,

    FMOD_THREADm_eCollType_MAX,
    FMOD_THREADm_eCollType_FORCEINT = 65536
} FMOD_THREADm_eCollType;
...
typedef enum FMOD_CHANNELCONTROLm_eCollType
{
...
} FMOD_CHANNELCONTROLm_eCollType;
...
typedef enum FMOD_SOUNDm_eCollType
{
    FMOD_SOUNDm_eCollType_UNKNOWN,
    FMOD_SOUNDm_eCollType_AIFF,
    FMOD_SOUNDm_eCollType_ASF,
    FMOD_SOUNDm_eCollType_DLS,
    FMOD_SOUNDm_eCollType_FLAC,
    FMOD_SOUNDm_eCollType_FSB,
    FMOD_SOUNDm_eCollType_IT,
    FMOD_SOUNDm_eCollType_MIDI,
    FMOD_SOUNDm_eCollType_MOD,
    FMOD_SOUNDm_eCollType_MPEG,
    FMOD_SOUNDm_eCollType_OGGVORBIS,
    FMOD_SOUNDm_eCollType_PLAYLIST,
    FMOD_SOUNDm_eCollType_RAW,
    FMOD_SOUNDm_eCollType_S3M,
    FMOD_SOUNDm_eCollType_USER,
    FMOD_SOUNDm_eCollType_WAV,
    FMOD_SOUNDm_eCollType_XM,
    FMOD_SOUNDm_eCollType_XMA,
    FMOD_SOUNDm_eCollType_AUDIOQUEUE,
    FMOD_SOUNDm_eCollType_AT9,
    FMOD_SOUNDm_eCollType_VORBIS,
    FMOD_SOUNDm_eCollType_MEDIA_FOUNDATION,
    FMOD_SOUNDm_eCollType_MEDIACODEC,
    FMOD_SOUNDm_eCollType_FADPCM,
    FMOD_SOUNDm_eCollType_OPUS,

    FMOD_SOUNDm_eCollType_MAX,
    FMOD_SOUNDm_eCollType_FORCEINT = 65536
} FMOD_SOUNDm_eCollType;
...
typedef enum FMOD_CHANNELCONTROL_CALLBACKm_eCollType
{
...
} FMOD_CHANNELCONTROL_CALLBACKm_eCollType;
...
typedef enum FMOD_DSP_CALLBACKm_eCollType
{
    FMOD_DSP_CALLBACK_DATAPARAMETERRELEASE,

    FMOD_DSP_CALLBACK_MAX,
    FMOD_DSP_CALLBACK_FORCEINT = 65536
} FMOD_DSP_CALLBACKm_eCollType;

typedef enum FMOD_DSPCONNECTIONm_eCollType
{
    FMOD_DSPCONNECTIONm_eCollType_STANDARD,
    FMOD_DSPCONNECTIONm_eCollType_SIDECHAIN,
    FMOD_DSPCONNECTIONm_eCollType_SEND,
    FMOD_DSPCONNECTIONm_eCollType_SEND_SIDECHAIN,

    FMOD_DSPCONNECTIONm_eCollType_MAX,
    FMOD_DSPCONNECTIONm_eCollType_FORCEINT = 65536
} FMOD_DSPCONNECTIONm_eCollType;
...
typedef enum FMOD_PORTm_eCollType
{
    FMOD_PORTm_eCollType_MUSIC,
    FMOD_PORTm_eCollType_COPYRIGHT_MUSIC,
    FMOD_PORTm_eCollType_VOICE,
    FMOD_PORTm_eCollType_CONTROLLER,
    FMOD_PORTm_eCollType_PERSONAL,
    FMOD_PORTm_eCollType_VIBRATION,
    FMOD_PORTm_eCollType_AUX,

    FMOD_PORTm_eCollType_MAX,
    FMOD_PORTm_eCollType_FORCEINT = 65536
} FMOD_PORTm_eCollType;
...
typedef FMOD_RESULT (F_CALL *FMOD_SYSTEM_CALLBACK)          (FMOD_SYSTEM *system, FMOD_SYSTEM_CALLBACKm_eCollType type, void *commanddata1, void* commanddata2, void *userdata);
typedef FMOD_RESULT (F_CALL *FMOD_CHANNELCONTROL_CALLBACK)  (FMOD_CHANNELCONTROL *channelcontrol, FMOD_CHANNELCONTROLm_eCollType controltype, FMOD_CHANNELCONTROL_CALLBACKm_eCollType callbacktype, void *commanddata1, void *commanddata2);
typedef FMOD_RESULT (F_CALL *FMOD_DSP_CALLBACK)             (FMOD_DSP *dsp, FMOD_DSP_CALLBACKm_eCollType type, void *data);
...
typedef void*       (F_CALL *FMOD_MEMORY_ALLOC_CALLBACK)    (unsigned int size, FMOD_MEMORYm_eCollType type, const char *sourcestr);
typedef void*       (F_CALL *FMOD_MEMORY_REALLOC_CALLBACK)  (void *ptr, unsigned int size, FMOD_MEMORYm_eCollType type, const char *sourcestr);
typedef void        (F_CALL *FMOD_MEMORY_FREE_CALLBACK)     (void *ptr, FMOD_MEMORYm_eCollType type, const char *sourcestr);
...
typedef struct FMOD_CREATESOUNDEXINFO
{
    ...
    int                            maxpolyphony;
    void                          *userdata;
    FMOD_SOUNDm_eCollType                suggestedsoundtype;
