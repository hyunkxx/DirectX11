...
public:
	enum RENDER_GROUP {
		...
		RENDER_UI_PRE, RENDER_UI, RENDER_UI_POST, RENDER_STATIC_SHADOW, RENDER_DYNAMIC_SHADOW, RENDER_END
	};
	enum LUT { LUT_EXPOSURE_MINUS, LUT_EXPOSURE_PLUS, LUT_FUJI, LUT_GRUNGY, LUT_SOUTH, LUT_KURO, LUT_LAST, LUT_DEFAULT };
