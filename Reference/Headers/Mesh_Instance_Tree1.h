...
class ENGINE_DLL CMesh_Instance_Tree1 final : public CVIBuffer
{
private:
	CMesh_Instance_Tree1(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMesh_Instance_Tree1(const CMesh_Instance_Tree1& rhs);
	virtual ~CMesh_Instance_Tree1() = default;
...
public:
	...
	void Safe_Angle(_float3 vAngle);
...
public:
	static CMesh_Instance_Tree1* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pMeshInfo,
